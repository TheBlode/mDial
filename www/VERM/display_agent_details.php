...
if (isset($_GET["start_datetime"])) {
    $start_datetime=$_GET["start_datetime"];
} elseif (isset($_POST["start_datetime"])) {
    $start_datetime=$_POST["start_datetime"];
}
if (isset($_GET["end_datetime"])) {
    $end_datetime=$_GET["end_datetime"];
} elseif (isset($_POST["end_datetime"])) {
    $end_datetime=$_POST["end_datetime"];
}
if (isset($_GET["total_duration_His"])) {
    $total_duration_His=$_GET["total_duration_His"];
} elseif (isset($_POST["total_duration_His"])) {
    $total_duration_His=$_POST["total_duration_His"];
}
if (isset($_GET["total_pause_His"])) {
    $total_pause_His=$_GET["total_pause_His"];
} elseif (isset($_POST["total_pause_His"])) {
    $total_pause_His=$_POST["total_pause_His"];
}
if (isset($_GET["total_all_billable_His"])) {
    $total_all_billable_His=$_GET["total_all_billable_His"];
} elseif (isset($_POST["total_all_billable_His"])) {
    $total_all_billable_His=$_POST["total_all_billable_His"];
}
if (isset($_GET["total_billable_His"])) {
    $total_billable_His=$_GET["total_billable_His"];
} elseif (isset($_POST["total_billable_His"])) {
    $total_billable_His=$_POST["total_billable_His"];
}
...
if (!$user || !$start_datetime || !$end_datetime) {
    echo "Missing information - needs a minimum of: user, start date/time, end date/time";
    die;
}
