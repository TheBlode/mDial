...
if (isset($_GET["download_rpt"])) {
    $download_rpt=$_GET["download_rpt"];
} elseif (isset($_POST["download_rpt"])) {
    $download_rpt=$_POST["download_rpt"];
}
if (isset($_GET["log_custom_report"])) {
    $log_custom_report=$_GET["log_custom_report"];
} elseif (isset($_POST["log_custom_report"])) {
    $log_custom_report=$_POST["log_custom_report"];
}
...
if (isset($_GET["vicidial_queue_groups"])) {
    $vicidial_queue_groups=$_GET["vicidial_queue_groups"];
} elseif (isset($_POST["vicidial_queue_groups"])) {
    $vicidial_queue_groups=$_POST["vicidial_queue_groups"];
}
if (isset($_GET["report_types"])) {
    $report_types=$_GET["report_types"];
} elseif (isset($_POST["report_types"])) {
    $report_types=$_POST["report_types"];
}
if (isset($_GET["report_types_to_display"])) {
    $report_types_to_display=$_GET["report_types_to_display"];
} elseif (isset($_POST["report_types_to_display"])) {
    $report_types_to_display=$_POST["report_types_to_display"];
}
...
if (isset($_GET["start_time_hour"])) {
    $start_time_hour=$_GET["start_time_hour"];
} elseif (isset($_POST["start_time_hour"])) {
    $start_time_hour=$_POST["start_time_hour"];
}
if (isset($_GET["start_time_min"])) {
    $start_time_min=$_GET["start_time_min"];
} elseif (isset($_POST["start_time_min"])) {
...
} elseif (isset($_POST["end_time_hour"])) {
    $end_time_hour=$_POST["end_time_hour"];
}
if (isset($_GET["end_time_min"])) {
    $end_time_min=$_GET["end_time_min"];
} elseif (isset($_POST["end_time_min"])) {
    $end_time_min=$_POST["end_time_min"];
}
if (isset($_GET["hourly_slot"])) {
    $hourly_slot=$_GET["hourly_slot"];
} elseif (isset($_POST["hourly_slot"])) {
    $hourly_slot=$_POST["hourly_slot"];
}
if (isset($_GET["SLA_initial_period"])) {
    $SLA_initial_period=$_GET["SLA_initial_period"];
} elseif (isset($_POST["SLA_initial_period"])) {
    $SLA_initial_period=$_POST["SLA_initial_period"];
}
if (isset($_GET["SLA_initial_interval"])) {
    $SLA_initial_interval=$_GET["SLA_initial_interval"];
} elseif (isset($_POST["SLA_initial_interval"])) {
    $SLA_initial_interval=$_POST["SLA_initial_interval"];
}
if (isset($_GET["SLA_max_period"])) {
    $SLA_max_period=$_GET["SLA_max_period"];
} elseif (isset($_POST["SLA_max_period"])) {
    $SLA_max_period=$_POST["SLA_max_period"];
}
if (isset($_GET["SLA_interval"])) {
    $SLA_interval=$_GET["SLA_interval"];
} elseif (isset($_POST["SLA_interval"])) {
    $SLA_interval=$_POST["SLA_interval"];
}
if (isset($_GET["short_call_wait_limit"])) {
    $short_call_wait_limit=$_GET["short_call_wait_limit"];
} elseif (isset($_POST["short_call_wait_limit"])) {
    $short_call_wait_limit=$_POST["short_call_wait_limit"];
}
if (isset($_GET["short_call_talk_limit"])) {
    $short_call_talk_limit=$_GET["short_call_talk_limit"];
} elseif (isset($_POST["short_call_talk_limit"])) {
    $short_call_talk_limit=$_POST["short_call_talk_limit"];
}
if (isset($_GET["short_attempt_wait_limit"])) {
    $short_attempt_wait_limit=$_GET["short_attempt_wait_limit"];
} elseif (isset($_POST["short_attempt_wait_limit"])) {
    $short_attempt_wait_limit=$_POST["short_attempt_wait_limit"];
}
if (isset($_GET["users"])) {
    $users=$_GET["users"];
...
if (isset($_GET["asterisk_cid"])) {
    $asterisk_cid=$_GET["asterisk_cid"];
} elseif (isset($_POST["asterisk_cid"])) {
    $asterisk_cid=$_POST["asterisk_cid"];
}
...
if (isset($_GET["wait_sec_min"])) {
    $wait_sec_min=$_GET["wait_sec_min"];
} elseif (isset($_POST["wait_sec_min"])) {
    $wait_sec_min=$_POST["wait_sec_min"];
}
if (isset($_GET["wait_sec_max"])) {
    $wait_sec_max=$_GET["wait_sec_max"];
} elseif (isset($_POST["wait_sec_max"])) {
    $wait_sec_max=$_POST["wait_sec_max"];
}
if (isset($_GET["length_in_sec_min"])) {
    $length_in_sec_min=$_GET["length_in_sec_min"];
} elseif (isset($_POST["length_in_sec_min"])) {
    $length_in_sec_min=$_POST["length_in_sec_min"];
}
if (isset($_GET["length_in_sec_max"])) {
    $length_in_sec_max=$_GET["length_in_sec_max"];
} elseif (isset($_POST["length_in_sec_max"])) {
    $length_in_sec_max=$_POST["length_in_sec_max"];
}
if (isset($_GET["disconnection_cause"])) {
    $disconnection_cause=$_GET["disconnection_cause"];
} elseif (isset($_POST["disconnection_cause"])) {
    $disconnection_cause=$_POST["disconnection_cause"];
}
if (isset($_GET["queue_position_min"])) {
    $queue_position_min=$_GET["queue_position_min"];
} elseif (isset($_POST["queue_position_min"])) {
    $queue_position_min=$_POST["queue_position_min"];
}
if (isset($_GET["queue_position_max"])) {
    $queue_position_max=$_GET["queue_position_max"];
} elseif (isset($_POST["queue_position_max"])) {
    $queue_position_max=$_POST["queue_position_max"];
}
if (isset($_GET["call_count_min"])) {
    $call_count_min=$_GET["call_count_min"];
} elseif (isset($_POST["call_count_min"])) {
    $call_count_min=$_POST["call_count_min"];
}
if (isset($_GET["call_count_max"])) {
    $call_count_max=$_GET["call_count_max"];
} elseif (isset($_POST["call_count_max"])) {
    $call_count_max=$_POST["call_count_max"];
}
if (isset($_GET["did"])) {
    $did=$_GET["did"];
...
if (isset($_GET["ivr_choice"])) {
    $ivr_choice=$_GET["ivr_choice"];
} elseif (isset($_POST["ivr_choice"])) {
    $ivr_choice=$_POST["ivr_choice"];
}
...
if (isset($_GET["time_of_day_start"])) {
    $time_of_day_start=$_GET["time_of_day_start"];
} elseif (isset($_POST["time_of_day_start"])) {
    $time_of_day_start=$_POST["time_of_day_start"];
}
if (isset($_GET["time_of_day_end"])) {
    $time_of_day_end=$_GET["time_of_day_end"];
} elseif (isset($_POST["time_of_day_end"])) {
    $time_of_day_end=$_POST["time_of_day_end"];
}
...
$report_log_count=0;
if (!$auto_download_limit) {
    $auto_download_limit=99999999999;
}
if ($total_calls>$auto_download_limit) {
    $agents_dt_download_notice=1;
}
if ($total_answered_calls>$auto_download_limit) {
    $answered_dt_download_notice=1;
}
if ($total_unanswered_calls>$auto_download_limit) {
    $unanswered_dt_download_notice=1;
}
