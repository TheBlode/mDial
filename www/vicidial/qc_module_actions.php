...
if (isset($_GET["modify_date"])) {
    $modify_date=$_GET["modify_date"];
} elseif (isset($_POST["modify_date"])) {
    $modify_date=$_POST["modify_date"];
}
if (isset($_GET["claim_rec"])) {
    $claim_rec=$_GET["claim_rec"];
} elseif (isset($_POST["claim_rec"])) {
    $claim_rec=$_POST["claim_rec"];
}
...
if (isset($_GET["qc_action"])) {
    $qc_action=$_GET["qc_action"];
} elseif (isset($_POST["qc_action"])) {
...
if (isset($_GET["qc_row_id"])) {
    $qc_row_id=$_GET["qc_row_id"];
} elseif (isset($_POST["qc_row_id"])) {
    $qc_row_id=$_POST["qc_row_id"];
}
if (isset($_GET["qc_log_id"])) {
    $qc_log_id=$_GET["qc_log_id"];
} elseif (isset($_POST["qc_log_id"])) {
    $qc_log_id=$_POST["qc_log_id"];
}
if (isset($_GET["qc_status"])) {
    $qc_status=$_GET["qc_status"];
} elseif (isset($_POST["qc_status"])) {
    $qc_status=$_POST["qc_status"];
}
if (isset($_GET["qc_agent_comments"])) {
    $qc_agent_comments=$_GET["qc_agent_comments"];
} elseif (isset($_POST["qc_agent_comments"])) {
    $qc_agent_comments=$_POST["qc_agent_comments"];
}
if (isset($_GET["qc_manager_comments"])) {
    $qc_manager_comments=$_GET["qc_manager_comments"];
} elseif (isset($_POST["qc_manager_comments"])) {
    $qc_manager_comments=$_POST["qc_manager_comments"];
}
...
} elseif (isset($_POST["field_value"])) {
...
if (isset($_GET["callback_time"])) {
    $callback_time=$_GET["callback_time"];
} elseif (isset($_POST["callback_time"])) {
...
if (isset($_GET["qc_checkpoint_log_id"])) {
    $qc_checkpoint_log_id=$_GET["qc_checkpoint_log_id"];
} elseif (isset($_POST["qc_checkpoint_log_id"])) {
    $qc_checkpoint_log_id=$_POST["qc_checkpoint_log_id"];
}
if (isset($_GET["qc_level"])) {
    $qc_level=$_GET["qc_level"];
} elseif (isset($_POST["qc_level"])) {
    $qc_level=$_POST["qc_level"];
}
if (isset($_GET["checkpoint_rank"])) {
    $checkpoint_rank=$_GET["checkpoint_rank"];
} elseif (isset($_POST["checkpoint_rank"])) {
    $checkpoint_rank=$_POST["checkpoint_rank"];
}
if (isset($_GET["checkpoint_points"])) {
    $checkpoint_points=$_GET["checkpoint_points"];
} elseif (isset($_POST["checkpoint_points"])) {
    $checkpoint_points=$_POST["checkpoint_points"];
}
if (isset($_GET["checkpoint_points_earned"])) {
    $checkpoint_points_earned=$_GET["checkpoint_points_earned"];
} elseif (isset($_POST["checkpoint_points_earned"])) {
    $checkpoint_points_earned=$_POST["checkpoint_points_earned"];
}
if (isset($_GET["new_checkpoint_points"])) {
    $new_checkpoint_points=$_GET["new_checkpoint_points"];
} elseif (isset($_POST["new_checkpoint_points"])) {
    $new_checkpoint_points=$_POST["new_checkpoint_points"];
}
if (isset($_GET["checkpoint_points_failed"])) {
    $checkpoint_points_failed=$_GET["checkpoint_points_failed"];
} elseif (isset($_POST["checkpoint_points_failed"])) {
    $checkpoint_points_failed=$_POST["checkpoint_points_failed"];
}
if (isset($_GET["old_checkpoint_rank"])) {
    $old_checkpoint_rank=$_GET["old_checkpoint_rank"];
} elseif (isset($_POST["old_checkpoint_rank"])) {
    $old_checkpoint_rank=$_POST["old_checkpoint_rank"];
}
if (isset($_GET["new_checkpoint_rank"])) {
    $new_checkpoint_rank=$_GET["new_checkpoint_rank"];
} elseif (isset($_POST["new_checkpoint_rank"])) {
    $new_checkpoint_rank=$_POST["new_checkpoint_rank"];
}
...
if (isset($_GET["new_commission_loss"])) {
    $new_commission_loss=$_GET["new_commission_loss"];
} elseif (isset($_POST["new_commission_loss"])) {
    $new_commission_loss=$_POST["new_commission_loss"];
}
if (isset($_GET["new_instant_fail"])) {
    $new_instant_fail=$_GET["new_instant_fail"];
} elseif (isset($_POST["new_instant_fail"])) {
    $new_instant_fail=$_POST["new_instant_fail"];
}
if (isset($_GET["new_admin_notes"])) {
    $new_admin_notes=$_GET["new_admin_notes"];
} elseif (isset($_POST["new_admin_notes"])) {
    $new_admin_notes=$_POST["new_admin_notes"];
}
if (isset($_GET["new_checkpoint_text"])) {
    $new_checkpoint_text=$_GET["new_checkpoint_text"];
} elseif (isset($_POST["new_checkpoint_text"])) {
    $new_checkpoint_text=$_POST["new_checkpoint_text"];
}
if (isset($_GET["new_checkpoint_text_presets"])) {
    $new_checkpoint_text_presets=$_GET["new_checkpoint_text_presets"];
} elseif (isset($_POST["new_checkpoint_text_presets"])) {
    $new_checkpoint_text_presets=$_POST["new_checkpoint_text_presets"];
}
if (isset($_GET["checkpoint_row_id"])) {
    $checkpoint_row_id=$_GET["checkpoint_row_id"];
} elseif (isset($_POST["checkpoint_row_id"])) {
    $checkpoint_row_id=$_POST["checkpoint_row_id"];
}
if (isset($_GET["checkpoint_comment_agent"])) {
    $checkpoint_comment_agent=$_GET["checkpoint_comment_agent"];
} elseif (isset($_POST["checkpoint_comment_agent"])) {
    $checkpoint_comment_agent=$_POST["checkpoint_comment_agent"];
}
if (isset($_GET["checkpoint_answer"])) {
    $checkpoint_answer=$_GET["checkpoint_answer"];
} elseif (isset($_POST["checkpoint_answer"])) {
    $checkpoint_answer=$_POST["checkpoint_answer"];
}
if (isset($_GET["instant_fail"])) {
    $instant_fail=$_GET["instant_fail"];
} elseif (isset($_POST["instant_fail"])) {
    $instant_fail=$_POST["instant_fail"];
}
if (isset($_GET["instant_fail_value"])) {
    $instant_fail_value=$_GET["instant_fail_value"];
} elseif (isset($_POST["instant_fail_value"])) {
    $instant_fail_value=$_POST["instant_fail_value"];
}
if (isset($_GET["admin_notes"])) {
    $admin_notes=$_GET["admin_notes"];
} elseif (isset($_POST["admin_notes"])) {
    $admin_notes=$_POST["admin_notes"];
}
if (isset($_GET["commission_loss"])) {
    $commission_loss=$_GET["commission_loss"];
} elseif (isset($_POST["commission_loss"])) {
    $commission_loss=$_POST["commission_loss"];
}
...
if (isset($_GET["parameter_value"])) {
    $parameter_value=$_GET["parameter_value"];
} elseif (isset($_POST["parameter_value"])) {
    $parameter_value=$_POST["parameter_value"];
}
if (isset($_GET["recording_timestamp"])) {
    $recording_timestamp=$_GET["recording_timestamp"];
} elseif (isset($_POST["recording_timestamp"])) {
    $recording_timestamp=$_POST["recording_timestamp"];
}
if (isset($_POST["upd_customer"])) {
    $upd_customer=$_POST["upd_customer"];
} elseif (isset($_GET["upd_customer"])) {
    $upd_customer=$_GET["upd_customer"];
}
if (isset($_POST["view_epoch"])) {
    $view_epoch=$_POST["view_epoch"];
} elseif (isset($_GET["view_epoch"])) {
    $view_epoch=$_GET["view_epoch"];
}
...
if ($qc_action=="update_callback") {
    if ($callback_id && ($recipient || $CBuser || $callback_time)) {
        $update_cb_SQL="";
        if ($recipient) {
            $update_cb_SQL.="recipient='$recipient', ";
        }
        if ($CBuser) {
            $update_cb_SQL.="user='$CBuser', ";
        }
        if ($callback_time) {
            $update_cb_SQL.="callback_time='$callback_time', ";
        }
        if ($callback_comments) {
            $update_cb_SQL.="comments='" . mysqli_real_escape_string($link, $callback_comments) . "', ";
        }
        $update_cb_SQL=preg_replace('/, $/', "", $update_cb_SQL);
        if (strlen($update_cb_SQL)==0) {
            echo "0";
            exit;
        }
...
if ($scorecard_id && $qc_action=="update_checkpoint" && $checkpoint_row_id && $parameter) {
    ...
    } elseif ($parameter=="checkpoint_rank" && $new_checkpoint_rank && $old_checkpoint_rank) {
