...
} elseif (isset($_POST["report_name"])) {
...
} elseif (isset($_POST["path_name"])) {
    $path_name=$_POST["path_name"];
}
if (isset($_GET["presets_string"])) {
    $presets_string=$_GET["presets_string"];
} elseif (isset($_POST["presets_string"])) {
    $presets_string=$_POST["presets_string"];
}
if (isset($_GET["slave"])) {
    $slave=$_GET["slave"];
} elseif (isset($_POST["slave"])) {
    $slave=$_POST["slave"];
}
if (isset($_GET["custom_reports_user_groups"])) {
    $custom_reports_user_groups=$_GET["custom_reports_user_groups"];
} elseif (isset($_POST["custom_reports_user_groups"])) {
    $custom_reports_user_groups=$_POST["custom_reports_user_groups"];
}
if (isset($_GET["add_custom_report"])) {
    $add_custom_report=$_GET["add_custom_report"];
} elseif (isset($_POST["add_custom_report"])) {
    $add_custom_report=$_POST["add_custom_report"];
}
if (isset($_GET["delete_custom_report"])) {
    $delete_custom_report=$_GET["delete_custom_report"];
} elseif (isset($_POST["delete_custom_report"])) {
    $delete_custom_report=$_POST["delete_custom_report"];
}
if (isset($_GET["update_custom_report"])) {
    $update_custom_report=$_GET["update_custom_report"];
} elseif (isset($_POST["update_custom_report"])) {
    $update_custom_report=$_POST["update_custom_report"];
}
if (isset($_GET["upd_custom_report_id"])) {
    $upd_custom_report_id=$_GET["upd_custom_report_id"];
} elseif (isset($_POST["upd_custom_report_id"])) {
    $upd_custom_report_id=$_POST["upd_custom_report_id"];
}
if (isset($_GET["upd_report_name"])) {
    $upd_report_name=$_GET["upd_report_name"];
} elseif (isset($_POST["upd_report_name"])) {
    $upd_report_name=$_POST["upd_report_name"];
}
if (isset($_GET["upd_path_name"])) {
    $upd_path_name=$_GET["upd_path_name"];
} elseif (isset($_POST["upd_path_name"])) {
    $upd_path_name=$_POST["upd_path_name"];
}
if (isset($_GET["upd_presets_string"])) {
    $upd_presets_string=$_GET["upd_presets_string"];
} elseif (isset($_POST["upd_presets_string"])) {
    $upd_presets_string=$_POST["upd_presets_string"];
}
if (isset($_GET["upd_slave"])) {
    $upd_slave=$_GET["upd_slave"];
} elseif (isset($_POST["upd_slave"])) {
    $upd_slave=$_POST["upd_slave"];
}
if (isset($_GET["upd_domain"])) {
    $upd_domain=$_GET["upd_domain"];
} elseif (isset($_POST["upd_domain"])) {
    $upd_domain=$_POST["upd_domain"];
}
if (isset($_GET["upd_custom_reports_user_groups"])) {
    $upd_custom_reports_user_groups=$_GET["upd_custom_reports_user_groups"];
} elseif (isset($_POST["upd_custom_reports_user_groups"])) {
    $upd_custom_reports_user_groups=$_POST["upd_custom_reports_user_groups"];
}
...
if (mysqli_num_rows($rpt_rslt)>0) {
    ...
    while($rpt_row=mysqli_fetch_array($rpt_rslt)) {
        ...
        if ($bgcolor==$SSstd_row3_background) {
            $bgcolor=$SSstd_row4_background;
        } else {
