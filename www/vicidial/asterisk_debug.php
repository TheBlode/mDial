...
while ($servers_to_print > $o) {
    if ($Aserver_ip[$o] == "$group") {
        echo "<option selected value=\"$Aserver_ip[$o]\">$server_id[$o] - $Aserver_ip[$o]</option>\n";
    } else {
        echo "<option value=\"$Aserver_ip[$o]\">$server_id[$o] - $Aserver_ip[$o]</option>\n";
    }
    $o++;
}
echo "</SELECT>\n";
