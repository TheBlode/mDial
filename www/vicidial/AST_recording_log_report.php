...
if (isset($_GET["access_date_D"])) {
    $access_date_D=$_GET["access_date_D"];
} elseif (isset($_POST["access_date_D"])) {
    $access_date_D=$_POST["access_date_D"];
}
if (isset($_GET["access_date_end_D"])) {
    $access_date_end_D=$_GET["access_date_end_D"];
} elseif (isset($_POST["access_date_end_D"])) {
    $access_date_end_D=$_POST["access_date_end_D"];
}
if (isset($_GET["access_date_T"])) {
    $access_date_T=$_GET["access_date_T"];
} elseif (isset($_POST["access_date_T"])) {
    $access_date_T=$_POST["access_date_T"];
}
if (isset($_GET["access_date_end_T"])) {
    $access_date_end_T=$_GET["access_date_end_T"];
} elseif (isset($_POST["access_date_end_T"])) {
    $access_date_end_T=$_POST["access_date_end_T"];
}
if (isset($_GET["users"])) {
    $users=$_GET["users"];
...
if (isset($_GET["recording_date_D"])) {
    $recording_date_D=$_GET["recording_date_D"];
} elseif (isset($_POST["recording_date_D"])) {
    $recording_date_D=$_POST["recording_date_D"];
}
if (isset($_GET["recording_date_end_D"])) {
    $recording_date_end_D=$_GET["recording_date_end_D"];
} elseif (isset($_POST["recording_date_end_D"])) {
    $recording_date_end_D=$_POST["recording_date_end_D"];
}
if (isset($_GET["recording_date_T"])) {
    $recording_date_T=$_GET["recording_date_T"];
} elseif (isset($_POST["recording_date_T"])) {
    $recording_date_T=$_POST["recording_date_T"];
}
if (isset($_GET["recording_date_end_T"])) {
    $recording_date_end_T=$_GET["recording_date_end_T"];
} elseif (isset($_POST["recording_date_end_T"])) {
    $recording_date_end_T=$_POST["recording_date_end_T"];
}
...
if (!isset($access_date_D)) {
    $access_date_D=$NOW_DATE;
}
if (!isset($access_date_end_D)) {
    $access_date_end_D=$NOW_DATE;
}
if (!isset($access_date_T)) {
    $access_date_T="00:00:00";
}
if (!isset($access_date_end_T)) {
    $access_date_end_T="23:59:59";
}
...
$recording_date_SQL="";
if ($recording_date_D) {
    if (!isset($recording_date_end_D)) {
        $recording_date_end_D=$recording_date_D;
    }
