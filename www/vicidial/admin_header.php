...
<B><FONT FACE="ARIAL,HELVETICA" COLOR=white><?php echo _QXZ("ADMINISTRATION"); ?></FONT></B><BR>
    ...
    <TR WIDTH=160 BGCOLOR=#<?php echo "$SSmenu_background ";
            if ($SSadmin_row_click > 0) {
    ...
    <?php
            if (strlen($users_hh) > 25) {
                ...
                if ($sh=='list') {
                    $list_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='new') {
                    $new_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='copy') {
                    $copy_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='search') {
                    $search_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='stats') {
                    $stats_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='status') {
                    $status_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='sheet') {
                    $sheet_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='territory') {
                    $territory_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='newlimit') {
                    $newlimit_sh="CLASS=\"subhead_style_selected\"";
                }
                ?>
    <TR <?php echo $list_sh ?><?php if ($SSadmin_row_click > 0) {
        echo " onclick=\"window.document.location='$ADMIN?ADD=0A';\"";
    } ?>><TD ALIGN=LEFT>
    ...
    </TR><TR <?php echo $new_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    </TR><TR <?php echo $copy_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    </TR><TR <?php echo $search_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    </TR><TR <?php echo $stats_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    </TR><TR <?php echo $status_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    </TR><TR <?php echo $sheet_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    </TR><TR <?php echo $territory_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    </TR><TR <?php echo $newlimit_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <?php
            if (strlen($campaigns_hh) > 25) {
                ...
                if ($sh=='hotkey') {
                    $hotkey_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='recycle') {
                    $recycle_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='autoalt') {
                    $autoalt_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='pause') {
                    $pause_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='listmix') {
                    $listmix_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='preset') {
                    $preset_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='accid') {
                    $accid_sh="CLASS=\"subhead_style_selected\"";
                }
                ?>
        <TR <?php echo $list_sh ?><?php if ($SSadmin_row_click > 0) {
            echo " onclick=\"window.document.location='$ADMIN?ADD=10';\"";
        ...
        </TR><TR <?php echo $hotkey_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SSoutbound_autodial_active > 0) {
            ?>
            </TR><TR <?php echo $recycle_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            </TR><TR <?php echo $autoalt_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            </TR><TR <?php echo $listmix_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            <?php
                ...
                ?>
        </TR><TR <?php echo $pause_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $preset_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SScampaign_cid_areacodes_enabled > 0) {
            ?>
            </TR><TR <?php echo $accid_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <?php
        ...
        <TR BGCOLOR=#<?php echo "$SSmenu_background ";
                ...
                } ?>><TD ALIGN=LEFT <?php echo $lists_hh ?>><a href="<?php echo $ADMIN ?>?ADD=100" STYLE="text-decoration:none;"><?php echo $lists_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $lists_fc ?>"><?php echo $lists_bold ?><?php echo _QXZ("Lists"); ?></a></TD></TR>
        <?php
                if (strlen($lists_hh) > 25) {
                    ...
                    if ($sh=='lead') {
                        $lead_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='load') {
                        $load_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='dnc') {
                        $dnc_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='custom') {
                        $custom_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='cpcust') {
                        $cpcust_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='droplist') {
                        $droplist_sh="CLASS=\"subhead_style_selected\"";
                    }
                    ?>
            <TR <?php echo $list_sh ?><?php if ($SSadmin_row_click > 0) {
                echo " onclick=\"window.document.location='$ADMIN?ADD=100';\"";
            ...
            </TR><TR <?php echo $lead_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            </TR><TR <?php echo $dnc_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            </TR><TR <?php echo $load_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            if ($SScustom_fields_enabled > 0) {
                ...
                ?>
                </TR><TR <?php echo $custom_sh ?><?php if ($SSadmin_row_click > 0) {
                ...
                </TR><TR <?php echo $cpcust_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            if ($SSenable_drop_lists > 0) {
                ?>
                <TR <?php echo $droplist_sh ?><?php if ($SSadmin_row_click > 0) {
                    echo " onclick=\"window.document.location='$ADMIN?ADD=100';\"";
                } ?>><TD ALIGN=LEFT> &nbsp; 
    ...
    <?php
                if (strlen($qc_hh) > 25) {
                    ...
                    if ($sh=='campaign') {
                        $campaign_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='ingroup') {
                        $ingroup_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='list') {
                        $list_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='enter') {
                        $enter_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='modify') {
                        $modify_sh="CLASS=\"subhead_style_selected\"";
                    }
                    if ($sh=='scorecard') {
                        $scorecard_sh="CLASS=\"subhead_style_selected\"";
                    }
                    ?>
    <TR <?php echo $campaign_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <TR <?php echo $ingroup_sh ?><?php if ($SSadmin_row_click > 0) {
...
<!--
    <TR <?php echo $enter_sh ?><?php if ($SSadmin_row_click > 0) {
        echo " onclick=\"window.document.location='$ADMIN?ADD=100000000000000';\"";
    } ?>>
        <TD ALIGN=LEFT> &nbsp;
...
//-->
    <TR <?php echo $scorecard_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <TR <?php echo $modify_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <?php
        ...
        <TR BGCOLOR=#<?php echo "$SSmenu_background ";
                ...
                } ?>><TD ALIGN=LEFT <?php echo $filters_hh ?>><a href="<?php echo $ADMIN ?>?ADD=10000000" STYLE="text-decoration:none;"><?php echo $filters_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $filters_fc ?>"><?php echo $filters_bold ?> <?php echo _QXZ("Filters"); ?> </a></TD></TR>
        <?php
    ...
    <?php
            if (strlen($ingroups_hh) > 25) {
                ...
                if ($sh=='listIG') {
                    $listIG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='newIG') {
                    $newIG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='copyIG') {
                    $copyIG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='listEG') {
                    $listEG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='newEG') {
                    $newEG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='copyEG') {
                    $copyEG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='listCG') {
                    $listCG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='newCG') {
                    $newCG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='copyCG') {
                    $copyCG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='listDID') {
                    $listDID_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='newDID') {
                    $newDID_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='copyDID') {
                    $copyDID_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='didRA') {
                    $didRA_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='listCM') {
                    $listCM_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='newCM') {
                    $newCM_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='copyCM') {
                    $copyCM_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='listFPG') {
                    $listFPG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='newFPG') {
                    $newFPG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='addFPG') {
                    $addFPG_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($LOGdelete_from_dnc > 0) {
                ...
                ?>
        <TR <?php echo $listIG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $newIG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $copyIG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SSemail_enabled>0) {
            ?>
        <TR <?php echo $listEG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $newEG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $copyEG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php
                if ($SSchat_enabled>0) {
                    ?>
        <TR <?php echo $listCG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $newCG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $copyCG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php
                ...
                ?>
        </TD></TR><TR <?php echo $listDID_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $newDID_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $copyDID_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SSdid_ra_extensions_enabled > 0) {
            ?>
            </TD></TR><TR <?php echo $didRA_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            <?php
                ...
                ?>
        <TR WIDTH=160 CLASS="subhead_style"><TD><DIV CLASS="horiz_line_grey"></DIV></TD></TR>
        </TD></TR><TR <?php echo $listCM_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $newCM_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $copyCM_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php } ?>
        <TR WIDTH=160 CLASS="subhead_style"><TD><DIV CLASS="horiz_line_grey"></DIV></TD></TR>
        </TD></TR><TR <?php echo $listFPG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $newFPG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TD></TR><TR <?php echo $addFPG_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <?php
            if (strlen($usergroups_hh) > 25) {
                ...
                if ($sh=='hour') {
                    $hour_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='bulk') {
                    $bulk_sh="CLASS=\"subhead_style_selected\"";
                }
                ?>
        <TR <?php echo $list_sh ?><?php if ($SSadmin_row_click > 0) {
            echo " onclick=\"window.document.location='$ADMIN?ADD=100000';\"";
        ...
        </TR><TR <?php echo $hour_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $bulk_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <?php
        ...
        </TR><TR <?php echo $listEG_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $newEG_sh ?><?php if ($SSadmin_row_click > 0) {
    ...
    <?php
            if (strlen($admin_hh) > 25) {
                ...
                if ($sh=='times') {
                    $times_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='shifts') {
                    $shifts_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='templates') {
                    $templates_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='carriers') {
                    $carriers_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='phones') {
                    $phones_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='server') {
                    $server_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='conference') {
                    $conference_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='settings') {
                    $settings_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='label') {
                    $label_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='colors') {
                    $colors_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='status') {
                    $status_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='audio') {
                    $audio_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='moh') {
                    $moh_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='languages') {
                    $languages_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='soundboard') {
                    $soundboard_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='vm') {
                    $vm_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='tts') {
                    $tts_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='cc') {
                    $cc_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='cts') {
                    $cts_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='sc') {
                    $sc_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='sg') {
                    $sg_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='cg') {
                    $cg_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='vmmg') {
                    $vmmg_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='qg') {
                    $qg_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='emails') {
                    $emails_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='ar') {
                    $ar_sh="CLASS=\"subhead_style_selected\"";
                }
                if ($sh=='il') {
                    $il_sh="CLASS=\"subhead_style_selected\"";
                }
                ?>
        <TR <?php echo $times_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $shifts_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $phones_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $templates_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $carriers_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $server_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $conference_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $settings_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $label_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $colors_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        </TR><TR <?php echo $sg_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SScampaign_cid_areacodes_enabled > 0) {
            ?>
        </TR><TR <?php echo $cg_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php
                ...
                ?>
        </TR><TR <?php echo $vm_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php
        if ($SSemail_enabled > 0) { ?>
            <TR <?php echo $emails_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if (($sounds_central_control_active > 0) or ($SSsounds_central_control_active > 0)) { ?>
            <TR <?php echo $audio_sh ?><?php if ($SSadmin_row_click > 0) {
            ...
            <TR <?php echo $moh_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SSenable_languages > 0) { ?>
            <TR <?php echo $languages_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ((preg_match("/soundboard/", $SSactive_modules)) or ($SSagent_soundboards > 0)) {
            ?>
            <TR <?php echo $soundboard_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php
            ...
            ?>
            <TR <?php echo $vmmg_sh ?><?php if ($SSadmin_row_click > 0) {
                echo " onclick=\"window.document.location='<?php echo $ADMIN ?>?ADD=197000000000';\"";
        ...
        if ($SSenable_tts_integration > 0) { ?>
            <TR <?php echo $tts_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SScallcard_enabled > 0) { ?>
            <TR <?php echo $cc_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SScontacts_enabled > 0) { ?>
            <TR <?php echo $cts_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php }
        ?>
        </TR><TR <?php echo $sc_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SSenable_auto_reports > 0) { ?>
            <TR <?php echo $ar_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        if ($SSallow_ip_lists > 0) { ?>
            <TR <?php echo $il_sh ?><?php if ($SSadmin_row_click > 0) {
        ...
        <?php }
        ?>
        </TR><TR <?php echo $qg_sh ?><?php if ($SSadmin_row_click > 0) {
