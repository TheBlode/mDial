...
echo "<option ";
if ($group == 'call_date desc') {
    echo "SELECTED ";
} echo "value='call_date desc'>"._QXZ("Date-Time UP")."</option>";
echo "<option ";
if ($group == 'call_date asc') {
    echo "SELECTED ";
} echo "value='call_date asc'>"._QXZ("Date-Time DOWN")."</option>";
echo "<option ";
if ($group == 'invite_to_final desc') {
    echo "SELECTED ";
} echo "value='invite_to_final desc'>"._QXZ("Total-Dial UP")."</option>";
echo "<option ";
if ($group == 'invite_to_final asc') {
    echo "SELECTED ";
} echo "value='invite_to_final asc'>"._QXZ("Total-Dial DOWN")."</option>";
echo "<option ";
if ($group == 'invite_to_ring desc') {
    echo "SELECTED ";
} echo "value='invite_to_ring desc'>"._QXZ("Post-Dial UP")."</option>";
echo "<option ";
if ($group == 'invite_to_ring asc') {
    echo "SELECTED ";
} echo "value='invite_to_ring asc'>"._QXZ("Post-Dial DOWN")."</option>";
echo "<option ";
if ($group == 'ring_to_final desc') {
    echo "SELECTED ";
} echo "value='ring_to_final desc'>"._QXZ("Ring-Time UP")."</option>";
echo "<option ";
if ($group == 'ring_to_final asc') {
    echo "SELECTED ";
} echo "value='ring_to_final asc'>"._QXZ("Ring-Time DOWN")."</option>";
echo "\n<BR><BR>";
echo "</TD><TD VALIGN=TOP>\n";
