...
if (isset($_GET["date_with_hour"])) {
    $date_with_hour=$_GET["date_with_hour"];
} elseif (isset($_POST["date_with_hour"])) {
    $date_with_hour=$_POST["date_with_hour"];
}
...
if (!isset($date_with_hour)) {
    $date_with_hour = $date_with_hour_default;
}
