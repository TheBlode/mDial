...
if (isset($_GET["ShowCustPhoneCode"])) {
    $ShowCustPhoneCode=$_GET["ShowCustPhoneCode"];
} elseif (isset($_POST["ShowCustPhoneCode"])) {
    $ShowCustPhoneCode=$_POST["ShowCustPhoneCode"];
}
...
if (isset($_GET["AGENTlatency"])) {
    $AGENTlatency=$_GET["AGENTlatency"];
} elseif (isset($_POST["AGENTlatency"])) {
    $AGENTlatency=$_POST["AGENTlatency"];
}
...
if ($talking_to_print > 0) {
    ...
    while ($j < $talking_to_print) {
        ...
        if (($CUSTINFOdisplay>0 || ($CUSTPHONEdisplay>0 && $ShowCustPhoneCode)) && $Alead_id[$j]>0) {
            ...
            if ($ShowCustPhoneCode) {
                $custphone=$CIrow["phone_code"].$custphone;
            }
        }
