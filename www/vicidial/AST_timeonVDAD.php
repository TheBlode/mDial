...
if (isset($_GET["reset_counter"])) {
    $reset_counter=$_GET["reset_counter"];
} elseif (isset($_POST["reset_counter"])) {
    $reset_counter=$_POST["reset_counter"];
}
...
if (isset($_GET["closer_display"])) {
    $closer_display=$_GET["closer_display"];
} elseif (isset($_POST["closer_display"])) {
    $closer_display=$_POST["closer_display"];
}
if (isset($_GET["DB"])) {
    $DB=$_GET["DB"];
...
if ($closer_display>0) {
    $closer_display_reverse=0;
    $closer_reverse_link=_QXZ("DEFAULT");
} else {
    $closer_display_reverse=1;
    $closer_reverse_link=_QXZ("CLOSER");
}
...
if ($talking_to_print > 0) {
    ...
    while ($i < $talking_to_print) {
        ...
        if ($call_time_SEC[$i] < 10) {
            $call_time_SEC[$i] = "0$call_time_SEC[$i]";
        }
