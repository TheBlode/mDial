...
if (isset($_GET["query_dateY"])) {
    $query_dateY=$_GET["query_dateY"];
} elseif (isset($_POST["query_dateY"])) {
    $query_dateY=$_POST["query_dateY"];
}
if (isset($_GET["query_dateM"])) {
    $query_dateM=$_GET["query_dateM"];
} elseif (isset($_POST["query_dateM"])) {
    $query_dateM=$_POST["query_dateM"];
}
if (isset($_GET["query_dateD"])) {
    $query_dateD=$_GET["query_dateD"];
} elseif (isset($_POST["query_dateD"])) {
    $query_dateD=$_POST["query_dateD"];
}
...
if (isset($_GET["end_dateY"])) {
    $end_dateY=$_GET["end_dateY"];
} elseif (isset($_POST["end_dateY"])) {
    $end_dateY=$_POST["end_dateY"];
}
if (isset($_GET["end_dateM"])) {
    $end_dateM=$_GET["end_dateM"];
} elseif (isset($_POST["end_dateM"])) {
    $end_dateM=$_POST["end_dateM"];
}
if (isset($_GET["end_dateD"])) {
    $end_dateD=$_GET["end_dateD"];
} elseif (isset($_POST["end_dateD"])) {
