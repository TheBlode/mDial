...
if (isset($_GET["old_user"])) {
    $old_user=$_GET["old_user"];
} elseif (isset($_POST["old_user"])) {
...
if (isset($_GET["convert_to_anyone"])) {
    $convert_to_anyone=$_GET["convert_to_anyone"];
} elseif (isset($_POST["convert_to_anyone"])) {
    $convert_to_anyone=$_POST["convert_to_anyone"];
}
