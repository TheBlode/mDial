...
if (isset($_GET["dial_status_add"])) {
    $dial_status_add=$_GET["dial_status_add"];
} elseif (isset($_POST["dial_status_add"])) {
    $dial_status_add=$_POST["dial_status_add"];
}
if (isset($_GET["dial_status_remove"])) {
    $dial_status_remove=$_GET["dial_status_remove"];
} elseif (isset($_POST["dial_status_remove"])) {
    $dial_status_remove=$_POST["dial_status_remove"];
}
if (isset($_GET["include_ip"])) {
    $include_ip=$_GET["include_ip"];
} elseif (isset($_POST["include_ip"])) {
    $include_ip=$_POST["include_ip"];
}
                ...
                if ($camp_exists < 1) {
                    ...
                    if (strlen($dial_status_add) > 0) {
                        if (strlen($dial_status_add) > 6) {
                            ...
                            if (strlen($temp_dial_statuses)<2) {
                                $temp_dial_statuses = ' -';
                            }
        ...
        if ($modify_leads < 1) {
            ...
            if ($valid_number < 1) {
                ...
                if (preg_match("/1DAY|2DAY|3DAY|7DAY|14DAY|15DAY|21DAY|28DAY|30DAY|60DAY|90DAY|180DAY|360DAY/i", $duplicate_check)) {
                    $day_val=30;
                    if (preg_match("/1DAY/i", $duplicate_check)) {
                        $day_val=1;
                    }
                    if (preg_match("/2DAY/i", $duplicate_check)) {
                        $day_val=2;
                    }
                    if (preg_match("/3DAY/i", $duplicate_check)) {
                        $day_val=3;
                    }
                    if (preg_match("/7DAY/i", $duplicate_check)) {
                        $day_val=7;
                    }
                    if (preg_match("/14DAY/i", $duplicate_check)) {
                        $day_val=14;
                    }
                    if (preg_match("/15DAY/i", $duplicate_check)) {
                        $day_val=15;
                    }
                    if (preg_match("/21DAY/i", $duplicate_check)) {
                        $day_val=21;
                    }
                    if (preg_match("/28DAY/i", $duplicate_check)) {
                        $day_val=28;
                    }
...
if ($function == 'call_status_stats') {
    if(strlen($campaigns)<2) {
        ...
        foreach($outbound_array as $key => $val) {
            ...
            if (is_null($temp_stat_array["$key"])) {
                $temp_stat_array["$key"] = array();
            }
