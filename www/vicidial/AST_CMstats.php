...
if (isset($_GET["callmenus"])) {
    $callmenus=$_GET["callmenus"];
} elseif (isset($_POST["callmenus"])) {
    $callmenus=$_POST["callmenus"];
}
if (isset($_GET["type"])) {
    $type=$_GET["type"];
...
if ($report_type) {
    $MAIN.="<option value='$report_type' selected>$report_type</option>";
}
