...
if (isset($_GET["queryCID"])) {
    $queryCID=$_GET["queryCID"];
} elseif (isset($_POST["queryCID"])) {
    $queryCID=$_POST["queryCID"];
}
...
if (isset($_GET["ext_context"])) {
    $ext_context=$_GET["ext_context"];
} elseif (isset($_POST["ext_context"])) {
    $ext_context=$_POST["ext_context"];
}
if (isset($_GET["ext_priority"])) {
    $ext_priority=$_GET["ext_priority"];
} elseif (isset($_POST["ext_priority"])) {
    $ext_priority=$_POST["ext_priority"];
}
...
if (isset($_GET["extenName"])) {
    $extenName=$_GET["extenName"];
} elseif (isset($_POST["extenName"])) {
    $extenName=$_POST["extenName"];
}
if (isset($_GET["parkedby"])) {
    $parkedby=$_GET["parkedby"];
} elseif (isset($_POST["parkedby"])) {
    $parkedby=$_POST["parkedby"];
}
if (isset($_GET["extrachannel"])) {
    $extrachannel=$_GET["extrachannel"];
} elseif (isset($_POST["extrachannel"])) {
    $extrachannel=$_POST["extrachannel"];
}
...
if (isset($_GET["call_server_ip"])) {
    $call_server_ip=$_GET["call_server_ip"];
} elseif (isset($_POST["call_server_ip"])) {
    $call_server_ip=$_POST["call_server_ip"];
}
if (isset($_GET["CalLCID"])) {
    $CalLCID=$_GET["CalLCID"];
} elseif (isset($_POST["CalLCID"])) {
    $CalLCID=$_POST["CalLCID"];
}
...
if (isset($_GET["phone_ip"])) {
    $phone_ip=$_GET["phone_ip"];
} elseif (isset($_POST["phone_ip"])) {
    $phone_ip=$_POST["phone_ip"];
}
if (isset($_GET["enable_sipsak_messages"])) {
    $enable_sipsak_messages=$_GET["enable_sipsak_messages"];
} elseif (isset($_POST["enable_sipsak_messages"])) {
    $enable_sipsak_messages=$_POST["enable_sipsak_messages"];
}
if (isset($_GET["allow_sipsak_messages"])) {
    $allow_sipsak_messages=$_GET["allow_sipsak_messages"];
} elseif (isset($_POST["allow_sipsak_messages"])) {
    $allow_sipsak_messages=$_POST["allow_sipsak_messages"];
}
...
if (isset($_GET["FROMvdc"])) {
    $FROMvdc=$_GET["FROMvdc"];
} elseif (isset($_POST["FROMvdc"])) {
    $FROMvdc=$_POST["FROMvdc"];
}
if (isset($_GET["agentchannel"])) {
    $agentchannel=$_GET["agentchannel"];
} elseif (isset($_POST["agentchannel"])) {
    $agentchannel=$_POST["agentchannel"];
}
if (isset($_GET["usegroupalias"])) {
    $usegroupalias=$_GET["usegroupalias"];
} elseif (isset($_POST["usegroupalias"])) {
    $usegroupalias=$_POST["usegroupalias"];
}
...
if (isset($_GET["agent_dialed_number"])) {
    $agent_dialed_number=$_GET["agent_dialed_number"];
} elseif (isset($_POST["agent_dialed_number"])) {
    $agent_dialed_number=$_POST["agent_dialed_number"];
}
if (isset($_GET["agent_dialed_type"])) {
    $agent_dialed_type=$_GET["agent_dialed_type"];
} elseif (isset($_POST["agent_dialed_type"])) {
    $agent_dialed_type=$_POST["agent_dialed_type"];
}
if (isset($_GET["nodeletevdac"])) {
    $nodeletevdac=$_GET["nodeletevdac"];
} elseif (isset($_POST["nodeletevdac"])) {
    $nodeletevdac=$_POST["nodeletevdac"];
}
if (isset($_GET["alertCID"])) {
    $alertCID=$_GET["alertCID"];
} elseif (isset($_POST["alertCID"])) {
    $alertCID=$_POST["alertCID"];
}
...
if (isset($_GET["call_variables"])) {
    $call_variables=$_GET["call_variables"];
} elseif (isset($_POST["call_variables"])) {
    $call_variables=$_POST["call_variables"];
}
if (isset($_GET["log_campaign"])) {
    $log_campaign=$_GET["log_campaign"];
} elseif (isset($_POST["log_campaign"])) {
    $log_campaign=$_POST["log_campaign"];
}
if (isset($_GET["qm_extension"])) {
    $qm_extension=$_GET["qm_extension"];
} elseif (isset($_POST["qm_extension"])) {
    $qm_extension=$_POST["qm_extension"];
}
if (isset($_GET["customerparked"])) {
    $customerparked=$_GET["customerparked"];
} elseif (isset($_POST["customerparked"])) {
    $customerparked=$_POST["customerparked"];
}
...
$rslt=mysql_to_mysqli($stmt, $link);
if ($mel > 0) {
    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02129', $user, $server_ip, $session_name, $one_mysql_log);
}
...
if((strlen($user)<2) or (strlen($pass)<2) or ($auth==0)) {
    ...
    if((strlen($server_ip)<6) or (!isset($server_ip)) or ((strlen($session_name)<12) or (!isset($session_name)))) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02003', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        $SNauth=$row[0];
        if($SNauth==0) {
...
if ($ACTION=="SysCIDdtmfOriginate") {
    ...
    $rslt=mysql_to_mysqli($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02092', $user, $server_ip, $session_name, $one_mysql_log);
    }
...
if ($ACTION=="SysCIDOriginate") {
    if ((strlen($exten)<1) or (strlen($channel)<1) or (strlen($ext_context)<1) or (strlen($queryCID)<1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02004', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02149', $user, $server_ip, $session_name, $one_mysql_log);
        }
...
if ($ACTION=="OriginateName") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15)  or (strlen($extenName)<1)  or (strlen($ext_context)<1)  or (strlen($ext_priority)<1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02005', $user, $server_ip, $session_name, $one_mysql_log);
        }
...
if ($ACTION=="OriginateNameVmail") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15)  or (strlen($extenName)<1)  or (strlen($exten)<1)  or (strlen($ext_context)<1)  or (strlen($ext_priority)<1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02006', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $name_count = mysqli_num_rows($rslt);
        if ($name_count>0) {
            $row=mysqli_fetch_row($rslt);
...
if ($ACTION=="Originate") {
    if ((strlen($exten)<1) or (strlen($channel)<1) or (strlen($ext_context)<1) or ((strlen($queryCID)<10) and ($alertCID < 1))) {
        ...
        $call_type='';
        if ((strlen($call_type) < 1) and (preg_match("/^M/i", $queryCID))) {
            $call_type='M';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^Y/i", $queryCID))) {
            $call_type='Y';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^S/i", $queryCID))) {
            $call_type='S';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^AC/i", $queryCID))) {
            $call_type='AC';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^DC/i", $queryCID))) {
            $call_type='DC';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^DV/i", $queryCID))) {
            $call_type='DV';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^DO/i", $queryCID))) {
            $call_type='DO';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^BM/i", $queryCID))) {
            $call_type='BM';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^BW/i", $queryCID))) {
            $call_type='BW';
        }
        if ((strlen($call_type) < 1) and (preg_match("/^BB/i", $queryCID))) {
            $call_type='BB';
        }
        if ((preg_match("/^DO|^DV/i", $queryCID)) and ($dial_override_limit > 0)) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02150', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            if ($row[0] > 0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02151', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02152', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($row[0] >= $dial_override_limit) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02153', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                }
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02154', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row=mysqli_fetch_row($rslt);
                if ($row[0] >= $dial_override_limit) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02155', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02156', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02157', $user, $server_ip, $session_name, $one_mysql_log);
                    }
        ...
        if ((preg_match("/^900\d\d\*|^9900\d\d\*|^980\d\d\*|^9980\d\d\*|^8305888888888888\d90009|^8305888888888888\d98009/", $exten)) or (preg_match("/^Local\/900\d\d\*|^Local\/9900\d\d\*|^Local\/980\d\d\*|^Local\/9980\d\d\*|^Local\/8305888888888888\d90009|^Local\/8305888888888888\d98009/", $channel))) {
            if (preg_match("/^900\d\d\*|^9900\d\d\*|^980\d\d\*|^9980\d\d\*|^8305888888888888\d90009|^8305888888888888\d98009/", $exten)) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02144', $user, $server_ip, $session_name, $one_mysql_log);
                }
            ...
            if (preg_match("/^Local\/900\d\d\*|^Local\/9900\d\d\*|^Local\/980\d\d\*|^Local\/9980\d\d\*|^Local\/8305888888888888\d90009|^Local\/8305888888888888\d98009/", $channel)) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02145', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $le_id = mysqli_insert_id($link);
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02007', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02119', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02146', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02158', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ((strlen($lead_id) > 0) and (strlen($session_id) > 0) and (preg_match("/^DC/", $queryCID))) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02143', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        if ($agent_dialed_number > 0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00192', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if (strlen($preset_name) > 0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02093', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row=mysqli_fetch_row($rslt);
                if ($row[0] > 0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02094', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
        }
...
if ($ACTION=="HangupConfDial") {
    ...
    if ((strlen($exten)<3) or (strlen($queryCID)<15) or (strlen($ext_context)<1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02008', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        if ($row > 0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02009', $user, $server_ip, $session_name, $one_mysql_log);
            }
...
if ($ACTION=="Hangup") {
    ...
    $rslt=mysql_to_mysqli($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02010', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row='';
    $rowx='';
    $channel_live=1;
    if ((strlen($channel)<3) or (strlen($queryCID)<15)) {
        ...
        if (($auto_dial_level > 0) and (strlen($CalLCID)>2) and (strlen($exten)>2) and ($secondS > 0)) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02011', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rowx=mysqli_fetch_row($rslt);
            if ($rowx[0]==0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02012', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row=mysqli_fetch_row($rslt);
                if ($row[0]==0) {
                    $channel_live=0;
        ...
        if (($auto_dial_level < 1) and (strlen($stage)>2) and (strlen($channel)>2) and (strlen($exten)>2)) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02083', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            if ($row[0] > 0) {
                $channel_live=0;
        ...
        if ($channel_live==1) {
            if ((strlen($CalLCID)>15) and ($secondS > 0)) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02013', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $rowx=mysqli_fetch_row($rslt);
                if ($format=='debug') {
                    echo "\n<!-- $rowx[0]|$stmt -->";
                ...
                if ($rowx[0] > 0) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02014', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($format=='debug') {
                        echo "\n<!-- $rowx[0]|$stmt -->";
                    }
                    ...
                    if ($enable_queuemetrics_logging > 0) {
                        ...
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02015', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        if ($caller_connect > 0) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02016', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            ...
                            $rslt=mysql_to_mysqli($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02017', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            ...
                            if ($caller_complete < 1) {
                                ...
                                $rslt=mysql_to_mysqli($stmt, $linkB);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02018', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                ...
                                $rslt=mysql_to_mysqli($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02116', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                if ($DB) {
                                    echo "$stmt\n";
                                }
                                ...
                                $rslt=mysql_to_mysqli($stmt, $linkB);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02019', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                ...
                                if (($queuemetrics_socket == 'CONNECT_COMPLETE') and (strlen($queuemetrics_socket_url) > 10)) {
                                    if (preg_match("/--A--/", $queuemetrics_socket_url)) {
                                        ...
                                        $rslt=mysql_to_mysqli($stmt, $link);
                                        if ($mel > 0) {
                                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02128', $user, $server_ip, $session_name, $one_mysql_log);
                                        }
                                        if ($DB) {
                                            echo "$stmt\n";
                                        }
                                    ...
                                    if ($DB > 0) {
                                        echo "$queuemetrics_socket_url$socket_send_data_begin$socket_send_data<BR>\n";
                                    }
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02020', $user, $server_ip, $session_name, $one_mysql_log);
            }
...
if ($ACTION=="RedirectVD") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($exten)<1) or (strlen($campaign)<1) or (strlen($ext_context)<1) or (strlen($ext_priority)<1) or (strlen($uniqueid)<2) or (strlen($lead_id)<1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02021', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        if ($row[0] > 0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02022', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02023', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($nodeletevdac < 1) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02024', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        if ($customerparked > 0) {
            $parked_sec=0;
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02133', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if ($VAC_pl_ct > 0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02134', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
        }
        if (strlen($preset_name) > 0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02095', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $stmt = "SELECT count(*) from vicidial_xfer_stats where campaign_id='$campaign' and preset_name='$preset_name';";
            if ($format=='debug') {
                echo "\n<!-- $stmt -->";
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02096', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            if ($row[0] > 0) {
                $stmt = "UPDATE vicidial_xfer_stats SET xfer_count=(xfer_count+1) where campaign_id='$campaign' and preset_name='$preset_name';";
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02097', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        $ACTION="Redirect";
    }
...
if ($ACTION=="RedirectToPark") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($exten)<1) or (strlen($extenName)<1) or (strlen($ext_context)<1) or (strlen($ext_priority)<1) or (strlen($parkedby)<1)) {
        ...
        if ($stage!="2NDXfeR") {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02025', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $ACTION="Redirect";
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02098', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02099', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($format=='debug') {
                echo "\n<!-- $rowx[0]|$stmt -->";
            }
            ...
            if ($enable_queuemetrics_logging > 0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $linkB);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02100', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $VAC_eq_ct = mysqli_num_rows($rslt);
                if ($VAC_eq_ct > 0) {
                    $row=mysqli_fetch_row($rslt);
                ...
                if ($VAC_eq_ct > 0) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02101', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysqli_affected_rows($linkB);
                    if ($format=='debug') {
                        echo "\n<!-- $affected_rows|$stmt -->";
                    ...
                    if ($queuemetrics_record_hold > 0) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02120', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysqli_affected_rows($linkB);
                        if ($format=='debug') {
                            echo "\n<!-- $affected_rows|$stmt -->";
    ...
    $rslt=mysql_to_mysqli($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02086', $user, $server_ip, $session_name, $one_mysql_log);
    }
}
if ($ACTION=="RedirectFromPark") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($exten)<1) or (strlen($ext_context)<1) or (strlen($ext_priority)<1)) {
        ...
        if ($stage!="2NDXfeR") {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02026', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $ACTION="Redirect";
            $parked_sec=0;
            $stmt = "SELECT UNIX_TIMESTAMP(parked_time) FROM park_log where uniqueid='$uniqueid' and server_ip='$server_ip' and extension='$CalLCID' and (parked_sec < 1 or grab_time is NULL) order by parked_time desc limit 1;";
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02102', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VAC_pl_ct = mysqli_num_rows($rslt);
            if ($VAC_pl_ct > 0) {
                $row=mysqli_fetch_row($rslt);
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02103', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $stmt = "SELECT enable_queuemetrics_logging,queuemetrics_server_ip,queuemetrics_dbname,queuemetrics_login,queuemetrics_pass,queuemetrics_log_id,queuemetrics_record_hold FROM system_settings;";
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02104', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($format=='debug') {
                    echo "\n<!-- $rowx[0]|$stmt -->";
                }
                ...
                if ($enable_queuemetrics_logging > 0) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02105', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VAC_eq_ct = mysqli_num_rows($rslt);
                    if ($VAC_eq_ct > 0) {
                        $row=mysqli_fetch_row($rslt);
                    ...
                    if ($VAC_eq_ct > 0) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02106', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysqli_affected_rows($linkB);
                        if ($format=='debug') {
                            echo "\n<!-- $affected_rows|$stmt -->";
                        ...
                        if ($queuemetrics_record_hold > 0) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02121', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $VAC_eq_ct = mysqli_num_rows($rslt);
                            if ($VAC_eq_ct > 0) {
                                $row=mysqli_fetch_row($rslt);
                            ...
                            $rslt=mysql_to_mysqli($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02122', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $affected_rows = mysqli_affected_rows($linkB);
                            if ($format=='debug') {
                                echo "\n<!-- $affected_rows|$stmt -->";
                            ...
                            $rslt=mysql_to_mysqli($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02123', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $affected_rows = mysqli_affected_rows($linkB);
                            if ($format=='debug') {
                                echo "\n<!-- $affected_rows|$stmt -->";
    ...
    $rslt=mysql_to_mysqli($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02087', $user, $server_ip, $session_name, $one_mysql_log);
    }
}
if ($ACTION=="RedirectToParkIVR") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($exten)<1) or (strlen($extenName)<1) or (strlen($ext_context)<1) or (strlen($ext_priority)<1) or (strlen($parkedby)<1)) {
        ...
        if ($stage!="2NDXfeR") {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02088', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02107', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $stmt = "SELECT enable_queuemetrics_logging,queuemetrics_server_ip,queuemetrics_dbname,queuemetrics_login,queuemetrics_pass,queuemetrics_log_id,queuemetrics_record_hold FROM system_settings;";
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02108', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($format=='debug') {
                echo "\n<!-- $rowx[0]|$stmt -->";
            }
            ...
            if ($enable_queuemetrics_logging > 0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $linkB);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02109', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $VAC_eq_ct = mysqli_num_rows($rslt);
                if ($VAC_eq_ct > 0) {
                    $row=mysqli_fetch_row($rslt);
                ...
                if ($VAC_eq_ct > 0) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02110', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysqli_affected_rows($linkB);
                    if ($format=='debug') {
                        echo "\n<!-- $affected_rows|$stmt -->";
                    ...
                    if ($queuemetrics_record_hold > 0) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02124', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysqli_affected_rows($linkB);
                        if ($format=='debug') {
                            echo "\n<!-- $affected_rows|$stmt -->";
    ...
    $rslt=mysql_to_mysqli($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02089', $user, $server_ip, $session_name, $one_mysql_log);
    }
}
if ($ACTION=="RedirectFromParkIVR") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($exten)<1) or (strlen($ext_context)<1) or (strlen($ext_priority)<1)) {
        ...
        if ($stage!="2NDXfeR") {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02090', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $parked_sec=0;
            $stmt = "SELECT UNIX_TIMESTAMP(parked_time) FROM park_log where uniqueid='$uniqueid' and server_ip='$server_ip' and extension='$CalLCID' and (parked_sec < 1 or grab_time is NULL) order by parked_time desc limit 1;";
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02111', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VAC_pl_ct = mysqli_num_rows($rslt);
            if ($VAC_pl_ct > 0) {
                $row=mysqli_fetch_row($rslt);
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02112', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $stmt = "SELECT enable_queuemetrics_logging,queuemetrics_server_ip,queuemetrics_dbname,queuemetrics_login,queuemetrics_pass,queuemetrics_log_id,queuemetrics_record_hold FROM system_settings;";
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02113', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($format=='debug') {
                    echo "\n<!-- $rowx[0]|$stmt -->";
                }
                ...
                if ($enable_queuemetrics_logging > 0) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02114', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VAC_eq_ct = mysqli_num_rows($rslt);
                    if ($VAC_eq_ct > 0) {
                        $row=mysqli_fetch_row($rslt);
                    ...
                    if ($VAC_eq_ct > 0) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02115', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysqli_affected_rows($linkB);
                        if ($format=='debug') {
                            echo "\n<!-- $affected_rows|$stmt -->";
                        ...
                        if ($queuemetrics_record_hold > 0) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02125', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $VAC_eq_ct = mysqli_num_rows($rslt);
                            if ($VAC_eq_ct > 0) {
                                $row=mysqli_fetch_row($rslt);
                            ...
                            $rslt=mysql_to_mysqli($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02126', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $affected_rows = mysqli_affected_rows($linkB);
                            if ($format=='debug') {
                                echo "\n<!-- $affected_rows|$stmt -->";
                            ...
                            $rslt=mysql_to_mysqli($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '02127', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $affected_rows = mysqli_affected_rows($linkB);
                            if ($format=='debug') {
                                echo "\n<!-- $affected_rows|$stmt -->";
    ...
    $rslt=mysql_to_mysqli($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02091', $user, $server_ip, $session_name, $one_mysql_log);
    }
}
if ($ACTION=="RedirectToParkXfer") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($exten)<1) or (strlen($extenName)<1) or (strlen($ext_context)<1) or (strlen($ext_priority)<1) or (strlen($parkedby)<1)) {
        ...
        if ($stage!="2NDXfeR") {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02141', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $ACTION="Redirect";
        }
    }
...
if ($ACTION=="RedirectFromParkXfer") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($exten)<1) or (strlen($ext_context)<1) or (strlen($ext_priority)<1)) {
        ...
        if ($stage!="2NDXfeR") {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02142', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $ACTION="Redirect";
        }
    }
...
if ($ACTION=="RedirectName") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15)  or (strlen($extenName)<1)  or (strlen($ext_context)<1)  or (strlen($ext_priority)<1)) {
        ...
        if ($customerparked > 0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02135', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VAC_pl_ct = mysqli_num_rows($rslt);
            if ($VAC_pl_ct > 0) {
                $row=mysqli_fetch_row($rslt);
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02136', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
        }
        $stmt="SELECT dialplan_number FROM phones where server_ip = '$server_ip' and extension='$extenName';";
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02027', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $name_count = mysqli_num_rows($rslt);
        if ($name_count>0) {
            $row=mysqli_fetch_row($rslt);
...
if ($ACTION=="RedirectNameVmail") {
    if ((strlen($channel)<3) or (strlen($queryCID)<15)  or (strlen($extenName)<1)  or (strlen($exten)<1)  or (strlen($ext_context)<1)  or (strlen($ext_priority)<1)) {
        ...
        if ($customerparked > 0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02137', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VAC_pl_ct = mysqli_num_rows($rslt);
            if ($VAC_pl_ct > 0) {
                $row=mysqli_fetch_row($rslt);
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02138', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
        }
        $stmt="SELECT voicemail_id FROM phones where server_ip = '$server_ip' and extension='$extenName';";
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02028', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $name_count = mysqli_num_rows($rslt);
        if ($name_count>0) {
            $row=mysqli_fetch_row($rslt);
...
if ($ACTION=="RedirectXtraCXNeW") {
    ...
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($ext_context)<1) or (strlen($ext_priority)<1) or (strlen($session_id)<3) or (((strlen($extrachannel)<3) or (strlen($exten)<1)) and (!preg_match("/NEXTAVAILABLE/", $exten)))) {
        ...
        if (preg_match("/NEXTAVAILABLE/", $exten)) {
            ...
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '02029', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            if ($row[0] > 1) {
                ...
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtB, '02030', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtC, '02031', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row=mysqli_fetch_row($rslt);
                $exten = $row[0];
                ...
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtD, '02032', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtE, '02033', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtF, '02034', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtG, '02035', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($auto_dial_level < 1) {
                    ...
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmtH, '02036', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                }
                ...
                if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                    $DBout .= "Cannot find empty conference on $server_ip";
                }
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02037', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        if ($row[0]==0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02038', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rowx=mysqli_fetch_row($rslt);
            if ($rowx[0]==0) {
                $channel_liveX=0;
                ...
                if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                    $DBout .= "$channel is not live on $call_server_ip";
                }
            }
        }
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02039', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        if ($row[0]==0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02040', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rowx=mysqli_fetch_row($rslt);
            if ($rowx[0]==0) {
                $channel_liveY=0;
                ...
                if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                    $DBout .= "$channel is not live on $server_ip";
                }
            }
        }
        if (($channel_liveX==1) and ($channel_liveY==1)) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02041', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rowx=mysqli_fetch_row($rslt);
            if ($rowx[0] < 1) {
                $channel_liveY=0;
                ...
                if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                    $DBout .= "No Local agent to send call to";
                }
            } else {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02042', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $rowx=mysqli_fetch_row($rslt);
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02043', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02044', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                    $DBout .= "$channel on $call_server_ip, Hungup $extrachannel on $server_ip";
                }
            }
        } else {
            if ($channel_liveX==1) {
            ...
            if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                $DBout .= "Changed to Redirect: $channel on $server_ip";
            }
        }
        if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
            if ($WeBRooTWritablE > 0) {
    ...
    if ($channel=="$extrachannel") {
        ...
        if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($ext_context)<1) or (strlen($ext_priority)<1) or (strlen($session_id)<3) or (((strlen($extrachannel)<3) or (strlen($exten)<1)) and (!preg_match("/NEXTAVAILABLE/", $exten)))) {
            ...
            if (preg_match("/NEXTAVAILABLE/", $exten)) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02045', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row=mysqli_fetch_row($rslt);
                if ($row[0] > 1) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02046', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02047', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $row=mysqli_fetch_row($rslt);
                    $exten = $row[0];
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02048', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02049', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmtB, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02050', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02051', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($auto_dial_level < 1) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02052', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                    echo "NeWSessioN|$exten|\n";
                    echo "|$stmtB|\n";
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02053', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            if (($row[0]==0) and (!preg_match("/SECOND/", $filename))) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02054', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $rowx=mysqli_fetch_row($rslt);
                if ($rowx[0]==0) {
                    $channel_liveX=0;
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02055', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            if (($row[0]==0) and (!preg_match("/SECOND/", $filename))) {
                $stmt="SELECT count(*) FROM live_sip_channels where server_ip = '$server_ip' and channel='$extrachannel';";
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02056', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $rowx=mysqli_fetch_row($rslt);
                if ($rowx[0]==0) {
                    $channel_liveY=0;
            ...
            if (($channel_liveX==1) and ($channel_liveY==1)) {
                if (($server_ip=="$call_server_ip") or (strlen($call_server_ip)<7)) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02057', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                        $DBout .= "$channel and $extrachannel to $exten on $server_ip";
                    }
                } else {
                    $S='*';
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02058', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02059', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    echo _QXZ("RedirectXtra command sent for Channel %1s on %2s and", 0, '', $channel, $call_server_ip)."\n";
                    echo _QXZ("ExtraChannel %1s", 0, '', $extrachannel)."\n";
                    echo _QXZ(" to %1s on %2s", 0, '', $exten, $server_ip)."\n";
                    if (preg_match("/SECOND|FIRST|DEBUG/", $filename)) {
                        $DBout .= "$channel/$call_server_ip and $extrachannel/$server_ip to $exten";
                    }
                }
            } else {
                if ($channel_liveX==1) {
...
if ($ACTION=="Redirect") {
    if ($stage=="2NDXfeR") {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02060', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        if ($row > 0) {
            $stmt="SELECT channel FROM live_sip_channels where server_ip = '$server_ip' and channel LIKE \"$hangup_channel_prefix%\";";
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02061', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rowx=mysqli_fetch_row($rslt);
            $channel=$rowx[0];
    ...
    if ((strlen($channel)<3) or (strlen($queryCID)<15)  or (strlen($exten)<1)  or (strlen($ext_context)<1)  or (strlen($ext_priority)<1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02062', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        if ($row[0]==0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02063', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rowx=mysqli_fetch_row($rslt);
            if ($rowx[0]==0) {
                $channel_live=0;
        ...
        if ($channel_live==1) {
            ...
            if ((preg_match("/^900\d\d\*|^9900\d\d\*|^980\d\d\*|^9980\d\d\*|^8305888888888888\d90009|^8305888888888888\d98009/", $exten)) or (preg_match("/^Local\/900\d\d\*|^Local\/9900\d\d\*|^Local\/980\d\d\*|^Local\/9980\d\d\*|^Local\/8305888888888888\d90009|^Local\/8305888888888888\d98009/", $channel))) {
                if (preg_match("/^900\d\d\*|^9900\d\d\*|^980\d\d\*|^9980\d\d\*|^8305888888888888\d90009|^8305888888888888\d98009/", $exten)) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02147', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $le_id = mysqli_insert_id($link);
                    $new_exten = preg_replace("/\*.*/", '', $exten);
                    $new_exten .= "**LEXTEN*$le_id";
                ...
                if (preg_match("/^Local\/900\d\d\*|^Local\/9900\d\d\*|^Local\/980\d\d\*|^Local\/9980\d\d\*|^Local\/8305888888888888\d90009|^Local\/8305888888888888\d98009/", $channel)) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02148', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $le_id = mysqli_insert_id($link);
                    $new_channel = preg_replace("/\*.*/", '', $temp_exten);
                    $new_channel = "Local/$new_channel**LEXTEN*$le_id@$temp_context";
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02064', $user, $server_ip, $session_name, $one_mysql_log);
            }
...
if (($ACTION=="Monitor") || ($ACTION=="StopMonitor")) {
    ...
    if ((strlen($channel)<3) or (strlen($queryCID)<15) or (strlen($filename)<8)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02065', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row=mysqli_fetch_row($rslt);
        if ($row[0]==0) {
            $stmt="SELECT count(*) FROM live_sip_channels where server_ip = '$server_ip' and channel='$channel';";
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02066', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rowx=mysqli_fetch_row($rslt);
            if ($rowx[0]==0) {
                $channel_live=0;
        ...
        if ($channel_live==1) {
            if (($ACTION=="Monitor") and (preg_match("/RECID/", $filename))) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02130', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02131', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $SQLfile = "File: $filename";
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02132', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02067', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($ACTION=="Monitor") {
                    $stmt = "INSERT INTO recording_log (channel,server_ip,extension,start_time,start_epoch,filename,lead_id,user) values('$channel','$server_ip','$exten','$NOW_TIME','$StarTtime','$filename','$lead_id','$user')";
                    if ($format=='debug') {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02068', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $stmt="SELECT recording_id FROM recording_log where filename='$filename' order by start_epoch desc;";
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02069', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02070', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($rec_count>0) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02071', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                }
                echo _QXZ("%1s command sent for Channel %2s on %3s", 0, '', $ACTION, $channel, $server_ip)."\nFilename: $filename\nRecorDing_ID: $recording_id\n";
...
if (($ACTION=="MonitorConf") || ($ACTION=="StopMonitorConf")) {
    ...
    if ((($ACTION=="MonitorConf") && ((strlen($exten)<3) or (strlen($channel)<4) or (strlen($filename)<8))) || (($ACTION=="StopMonitorConf") && ((strlen($exten)<3) or (strlen($channel)<4) or (strlen($filename)<4)))) {
        ...
        if ($ACTION=="MonitorConf") {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02139', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($rir_ct > 0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02140', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if (preg_match("/RECID/", $filename)) {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02159', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                } else {
                    $vmgr_callerid = substr($filename, 0, 17) . '...';
                    $stmt="INSERT INTO vicidial_manager values('','','$NOW_TIME','NEW','N','$server_ip','','Originate','$vmgr_callerid','Channel: $channel','Context: $ext_context','Exten: $exten','Priority: $ext_priority','Callerid: $filename','','','','','');";
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02072', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $stmt = "INSERT INTO vicidial_user_dial_log SET caller_code='$filename',user='$user',call_date='$NOW_TIME',call_type='RC',notes='$exten $ext_context $channel';";
                    if ($DB) {
                        echo "$stmt\n";
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02160', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $stmt = "INSERT INTO recording_log (channel,server_ip,extension,start_time,start_epoch,filename,lead_id,user) values('$channel','$server_ip','$exten','$NOW_TIME','$StarTtime','$filename','$lead_id','$user')";
                    if ($format=='debug') {
                        echo "\n<!-- $stmt -->";
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02073', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $RLaffected_rows = mysqli_affected_rows($link);
                    if ($RLaffected_rows > 0) {
                        $recording_id = mysqli_insert_id($link);
                ...
                if ($FROMvdc=='YES') {
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02117', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VLA_inOUT='NONE';
                    $stmt="SELECT comments FROM vicidial_live_agents where user='$user' order by last_update_time desc limit 1;";
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02074', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt=mysql_to_mysqli($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02075', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($VM_mancall_ct > 0) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02076', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                }
            ...
            if ($uniqueid=='IN') {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02077', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $VAC_qm_ct = mysqli_num_rows($rslt);
                if ($VAC_qm_ct > 0) {
                    $row=mysqli_fetch_row($rslt);
            ...
            if ($FROMvdc=='YES') {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02118', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02078', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($rec_count>0) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02079', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02080', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $rec_count = mysqli_num_rows($rslt);
            $HUchannel = array();
            $h=0;
            ...
            while ($h>$i) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02081', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $i++;
            }
        }
...
if ($ACTION=="VolumeControl") {
    if ((strlen($exten)<1) or (strlen($channel)<1) or (strlen($stage)<1) or (strlen($queryCID)<1)) {
        ...
        if (preg_match('/UP/i', $stage)) {
            $vol_prefix='4';
        }
        if (preg_match('/DOWN/i', $stage)) {
            $vol_prefix='3';
        }
        if (preg_match('/UNMUTE/i', $stage)) {
            $vol_prefix='2';
        }
        if (preg_match('/MUTING/i', $stage)) {
            $vol_prefix='1';
        }
        $local_DEF = 'Local/';
        $local_AMP = '@';
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02082', $user, $server_ip, $session_name, $one_mysql_log);
        }
...
if ($ACTION=="MuteRecording") {
    if ((strlen($channel)<1) or (strlen($stage)<1) or (strlen($queryCID)<1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '02144', $user, $server_ip, $session_name, $one_mysql_log);
        }
