...
} elseif (isset($_POST["sale_status"])) {
...
if (isset($_GET["call_notes"])) {
    $call_notes=$_GET["call_notes"];
} elseif (isset($_POST["call_notes"])) {
    $call_notes=$_POST["call_notes"];
}
if (isset($_GET["additional_notes"])) {
    $additional_notes=$_GET["additional_notes"];
} elseif (isset($_POST["additional_notes"])) {
...
if (isset($_GET["called_count_trigger"])) {
    $called_count_trigger=$_GET["called_count_trigger"];
} elseif (isset($_POST["called_count_trigger"])) {
    $called_count_trigger=$_POST["called_count_trigger"];
}
if (isset($_GET["email_to"])) {
    $email_to=$_GET["email_to"];
} elseif (isset($_POST["email_to"])) {
...
if (isset($_GET["email_attachment_1"])) {
    $email_attachment_1=$_GET["email_attachment_1"];
} elseif (isset($_POST["email_attachment_1"])) {
    $email_attachment_1=$_POST["email_attachment_1"];
}
if (isset($_GET["email_attachment_2"])) {
    $email_attachment_2=$_GET["email_attachment_2"];
} elseif (isset($_POST["email_attachment_2"])) {
    $email_attachment_2=$_POST["email_attachment_2"];
}
if (isset($_GET["email_attachment_3"])) {
    $email_attachment_3=$_GET["email_attachment_3"];
} elseif (isset($_POST["email_attachment_3"])) {
    $email_attachment_3=$_POST["email_attachment_3"];
}
if (isset($_GET["email_attachment_4"])) {
    $email_attachment_4=$_GET["email_attachment_4"];
} elseif (isset($_POST["email_attachment_4"])) {
    $email_attachment_4=$_POST["email_attachment_4"];
}
if (isset($_GET["email_attachment_5"])) {
    $email_attachment_5=$_GET["email_attachment_5"];
} elseif (isset($_POST["email_attachment_5"])) {
    $email_attachment_5=$_POST["email_attachment_5"];
}
if (isset($_GET["email_attachment_6"])) {
    $email_attachment_6=$_GET["email_attachment_6"];
} elseif (isset($_POST["email_attachment_6"])) {
    $email_attachment_6=$_POST["email_attachment_6"];
}
if (isset($_GET["email_attachment_7"])) {
    $email_attachment_7=$_GET["email_attachment_7"];
} elseif (isset($_POST["email_attachment_7"])) {
    $email_attachment_7=$_POST["email_attachment_7"];
}
if (isset($_GET["email_attachment_8"])) {
    $email_attachment_8=$_GET["email_attachment_8"];
} elseif (isset($_POST["email_attachment_8"])) {
    $email_attachment_8=$_POST["email_attachment_8"];
}
if (isset($_GET["email_attachment_9"])) {
    $email_attachment_9=$_GET["email_attachment_9"];
} elseif (isset($_POST["email_attachment_9"])) {
    $email_attachment_9=$_POST["email_attachment_9"];
}
if (isset($_GET["email_attachment_10"])) {
    $email_attachment_10=$_GET["email_attachment_10"];
} elseif (isset($_POST["email_attachment_10"])) {
    $email_attachment_10=$_POST["email_attachment_10"];
}
if (isset($_GET["email_attachment_11"])) {
...
if (isset($_GET["email_attachment_12"])) {
    $email_attachment_12=$_GET["email_attachment_12"];
} elseif (isset($_POST["email_attachment_12"])) {
    $email_attachment_12=$_POST["email_attachment_12"];
}
if (isset($_GET["email_attachment_13"])) {
    $email_attachment_13=$_GET["email_attachment_13"];
} elseif (isset($_POST["email_attachment_13"])) {
    $email_attachment_13=$_POST["email_attachment_13"];
}
if (isset($_GET["email_attachment_14"])) {
    $email_attachment_14=$_GET["email_attachment_14"];
} elseif (isset($_POST["email_attachment_14"])) {
    $email_attachment_14=$_POST["email_attachment_14"];
}
if (isset($_GET["email_attachment_15"])) {
    $email_attachment_15=$_GET["email_attachment_15"];
} elseif (isset($_POST["email_attachment_15"])) {
    $email_attachment_15=$_POST["email_attachment_15"];
}
if (isset($_GET["email_attachment_16"])) {
    $email_attachment_16=$_GET["email_attachment_16"];
} elseif (isset($_POST["email_attachment_16"])) {
    $email_attachment_16=$_POST["email_attachment_16"];
}
if (isset($_GET["email_attachment_17"])) {
    $email_attachment_17=$_GET["email_attachment_17"];
} elseif (isset($_POST["email_attachment_17"])) {
    $email_attachment_17=$_POST["email_attachment_17"];
}
if (isset($_GET["email_attachment_18"])) {
    $email_attachment_18=$_GET["email_attachment_18"];
} elseif (isset($_POST["email_attachment_18"])) {
    $email_attachment_18=$_POST["email_attachment_18"];
}
if (isset($_GET["email_attachment_19"])) {
    $email_attachment_19=$_GET["email_attachment_19"];
} elseif (isset($_POST["email_attachment_19"])) {
    $email_attachment_19=$_POST["email_attachment_19"];
}
if (isset($_GET["email_attachment_20"])) {
    $email_attachment_20=$_GET["email_attachment_20"];
} elseif (isset($_POST["email_attachment_20"])) {
    $email_attachment_20=$_POST["email_attachment_20"];
}
...
$EHA='';
if ($email_header_attach > 0) {
    $EHA="\n\n";
}
$stmt = "SELECT use_non_latin,enable_languages,language_method,allow_web_debug FROM system_settings;";
$rslt=mysql_to_mysqli($stmt, $link);
if ($mel > 0) {
    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60002', $user, $server_ip, $session_name, $one_mysql_log);
}
...
$rslt=mysql_to_mysqli($stmt, $link);
if ($mel > 0) {
    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60001', $user, $server_ip, $session_name, $one_mysql_log);
}
...
if ($DB>0) {
    echo "$lead_id|$container_id|$call_id|$sale_status|$dispo|$new_status|$called_count|$called_count_trigger|$user|$pass|$DB|$log_to_file|\n";
}
...
if ($match_found > 0) {
    ...
    if (preg_match("/NOAGENTURL/", $user)) {
        if (strlen($user) > 11) {
            $user = preg_replace("/NOAGENTURL/", '', $user);
        }
        ...
        if ((preg_match("/PAUSEMAX/", $lead_id)) and (preg_match("/$user$/", $pass))) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60015', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            $authlive=$row[0];
            $auth=$row[0];
            ...
            if ((strlen($pass) > 15) and (preg_match("/$PADlead_id$/", $pass))) {
                ...
                $rslt=mysql_to_mysqli($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60003', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row=mysqli_fetch_row($rslt);
                $authlive=$row[0];
                $auth=$row[0];
        ...
        if ($stage == 'offline') {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60004', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row=mysqli_fetch_row($rslt);
            $authlive=$row[0];
        }
    ...
    if ((strlen($lead_id) > 0) and (strlen($container_id) > 1)) {
        ...
        $rslt=mysql_to_mysqli($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60005', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ($SC_count > 0) {
            ...
            $rslt=mysql_to_mysqli($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60006', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($sc_ct > 0) {
                    ...
                    if ($email_body_gather < 1) {
                        ...
                        if (strlen($email_to) < 6) {
                            if (preg_match("/^email_to/", $line)) {
                                $email_to = $line;
                                $email_to = trim(preg_replace("/.*=/", '', $email_to));
                            }
                        }
                        if (preg_match("/^email_from/", $line)) {
                            $email_from = $line;
                            $email_from = trim(preg_replace("/.*=/", '', $email_from));
                        }
                        if (preg_match("/^email_display_name/", $line)) {
                            $email_display_name = $line;
                            $email_display_name = trim(preg_replace("/.*=/", '', $email_display_name));
                        }
                        if (preg_match("/^email_subject/", $line)) {
                            $email_subject = $line;
                            $email_subject = trim(preg_replace("/.*=/", '', $email_subject));
                        }
                        ...
                        if (preg_match("/^email_body_begin/", $line)) {
                            $email_body = $line;
                            $email_body = trim(preg_replace("/.*=/", '', $email_body)) . "\n";
                            $email_body_gather++;
                        }
                ...
                if ((strlen($email_to) > 5) and (strlen($email_from) > 5) and (strlen($email_subject) > 1) and (strlen($email_body) > 1)) {
                    if ((preg_match('/--A--/i', $email_subject)) or (preg_match('/--A--/i', $email_body)) or (preg_match('/--A--/i', $email_to)) or (preg_match('/--A--/i', $email_from)) or (preg_match('/--A--/i', $email_display_name))) {
                        ...
                        $rslt=mysql_to_mysqli($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60007', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        if ((preg_match('/list_name--B--|list_description--B--/i', $email_subject)) or (preg_match('/list_name--B--|list_description--B--/i', $email_body))) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60008', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                        ...
                        if ((preg_match('/--A--did_|--A--uniqueid/i', $email_subject)) or (preg_match('/--A--did_|--A--uniqueid/i', $email_body))) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60009', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                        ...
                        if ((preg_match('/--A--did_/i', $email_subject)) or (preg_match('/--A--did_/i', $email_body))) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60010', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $VDIDL_ct = mysqli_num_rows($rslt);
                            if ($VDIDL_ct > 0) {
                                $row=mysqli_fetch_row($rslt);
                                ...
                                $rslt=mysql_to_mysqli($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60011', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                $VDIDL_ct = mysqli_num_rows($rslt);
                                if ($VDIDL_ct > 0) {
                                    $row=mysqli_fetch_row($rslt);
                        ...
                        if ((preg_match('/--A--camp_custom_|--A--campaign/i', $email_subject)) or (preg_match('/--A--camp_custom_|--A--campaign/i', $email_body)) or (preg_match('/--A--camp_custom_/i', $email_from)) or (preg_match('/--A--camp_custom_/i', $email_to)) or (preg_match('/--A--camp_custom_/i', $email_display_name))) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60016', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $VDIDL_ct = mysqli_num_rows($rslt);
                            if ($VDIDL_ct > 0) {
                                $row=mysqli_fetch_row($rslt);
                                ...
                                $rslt=mysql_to_mysqli($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60017', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                $VDIDL_ct = mysqli_num_rows($rslt);
                                if ($VDIDL_ct > 0) {
                                    $row=mysqli_fetch_row($rslt);
                            ...
                            if (strlen($campaign) > 0) {
                                ...
                                $rslt=mysql_to_mysqli($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60018', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                $VDIDL_ct = mysqli_num_rows($rslt);
                                if ($VDIDL_ct > 0) {
                                    $row=mysqli_fetch_row($rslt);
                        ...
                        if ((preg_match('/--A--ig_custom_|--A--group_id/i', $email_subject)) or (preg_match('/--A--ig_custom_|--A--group_id/i', $email_body)) or (preg_match('/--A--ig_custom_/i', $email_from)) or (preg_match('/--A--ig_custom_/i', $email_to)) or (preg_match('/--A--ig_custom_/i', $email_display_name))) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60019', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $VDIDL_ct = mysqli_num_rows($rslt);
                            if ($VDIDL_ct > 0) {
                                $row=mysqli_fetch_row($rslt);
                                ...
                                $rslt=mysql_to_mysqli($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60020', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                $VDIDL_ct = mysqli_num_rows($rslt);
                                if ($VDIDL_ct > 0) {
                                    $row=mysqli_fetch_row($rslt);
                        ...
                        $rslt=mysql_to_mysqli($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60012', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        if ((preg_match('/--A--CF_uses_custom_fields--B--/i', $email_subject)) or (preg_match('/--A--CF_uses_custom_fields--B--/i', $email_body))) {
                            ...
                            $rslt=mysql_to_mysqli($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60013', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            if ($DB) {
                                echo "$stmt\n";
                            }
                            ...
                            if ($d > 0) {
                                ...
                                $rslt=mysql_to_mysqli($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '60014', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                if ($DB) {
                                    echo "$stmt\n";
                                }
                                ...
                                if ($list_lead_ct > 0) {
                                    ...
                                    while ($cffn_ct > $d) {
                                        ...
                                        if ($DB) {
                                            echo "$d|$field_name_id[$d]|$field_name_tag|$form_field_value|<br>\n";
                                        }
                                        $d++;
                                    }
                                }
                    ...
                    if ((strlen($email_attachment_1) > 4) or (strlen($email_attachment_2) > 4) or (strlen($email_attachment_3) > 4) or (strlen($email_attachment_4) > 4) or (strlen($email_attachment_5) > 4) or (strlen($email_attachment_6) > 4) or (strlen($email_attachment_7) > 4) or (strlen($email_attachment_8) > 4) or (strlen($email_attachment_9) > 4) or (strlen($email_attachment_10) > 4) or (strlen($email_attachment_11) > 4) or (strlen($email_attachment_12) > 4) or (strlen($email_attachment_13) > 4) or (strlen($email_attachment_14) > 4) or (strlen($email_attachment_15) > 4) or (strlen($email_attachment_16) > 4) or (strlen($email_attachment_17) > 4) or (strlen($email_attachment_18) > 4) or (strlen($email_attachment_19) > 4) or (strlen($email_attachment_20) > 4)) {
                        if (strlen($email_attachment_1) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_1)) or (file_exists($PATHLEGemail_attachment_1))) {
                                if (!file_exists($PATHemail_attachment_1)) {
                                    $PATHemail_attachment_1 = $PATHLEGemail_attachment_1;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_1: $filename_1($PATHemail_attachment_1) $file_size\n";
                                }
                                $attach_messages .= "attachment_1: $filename_1($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_1 does not exist: |$email_attachment_1|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_1: |$email_attachment_1|\n";
                            }
                            $email_attachment_1='';
                        }
                        if (strlen($email_attachment_2) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_2)) or (file_exists($PATHLEGemail_attachment_2))) {
                                if (!file_exists($PATHemail_attachment_2)) {
                                    $PATHemail_attachment_2 = $PATHLEGemail_attachment_2;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_2: $filename_2($PATHemail_attachment_2) $file_size\n";
                                }
                                $attach_messages .= "attachment_2: $filename_2($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_2 does not exist: |$email_attachment_2|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_2: |$email_attachment_2|\n";
                            }
                            $email_attachment_2='';
                        }
                        if (strlen($email_attachment_3) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_3)) or (file_exists($PATHLEGemail_attachment_3))) {
                                if (!file_exists($PATHemail_attachment_3)) {
                                    $PATHemail_attachment_3 = $PATHLEGemail_attachment_3;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_3: $filename_3($PATHemail_attachment_3) $file_size\n";
                                }
                                $attach_messages .= "attachment_3: $filename_3($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_3 does not exist: |$email_attachment_3|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_3: |$email_attachment_3|\n";
                            }
                            $email_attachment_3='';
                        }
                        if (strlen($email_attachment_4) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_4)) or (file_exists($PATHLEGemail_attachment_4))) {
                                if (!file_exists($PATHemail_attachment_4)) {
                                    $PATHemail_attachment_4 = $PATHLEGemail_attachment_4;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_4: $filename_4($PATHemail_attachment_4) $file_size\n";
                                }
                                $attach_messages .= "attachment_4: $filename_4($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_4 does not exist: |$email_attachment_4|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_4: |$email_attachment_4|\n";
                            }
                            $email_attachment_4='';
                        }
                        if (strlen($email_attachment_5) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_5)) or (file_exists($PATHLEGemail_attachment_5))) {
                                if (!file_exists($PATHemail_attachment_5)) {
                                    $PATHemail_attachment_5 = $PATHLEGemail_attachment_5;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_5: $filename_5($PATHemail_attachment_5) $file_size\n";
                                }
                                $attach_messages .= "attachment_5: $filename_5($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_5 does not exist: |$email_attachment_5|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_5: |$email_attachment_5|\n";
                            }
                            $email_attachment_5='';
                        }
                        if (strlen($email_attachment_6) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_6)) or (file_exists($PATHLEGemail_attachment_6))) {
                                if (!file_exists($PATHemail_attachment_6)) {
                                    $PATHemail_attachment_6 = $PATHLEGemail_attachment_6;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_6: $filename_6($PATHemail_attachment_6) $file_size\n";
                                }
                                $attach_messages .= "attachment_6: $filename_6($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_6 does not exist: |$email_attachment_6|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_6: |$email_attachment_6|\n";
                            }
                            $email_attachment_6='';
                        }
                        if (strlen($email_attachment_7) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_7)) or (file_exists($PATHLEGemail_attachment_7))) {
                                if (!file_exists($PATHemail_attachment_7)) {
                                    $PATHemail_attachment_7 = $PATHLEGemail_attachment_7;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_7: $filename_7($PATHemail_attachment_7) $file_size\n";
                                }
                                $attach_messages .= "attachment_7: $filename_7($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_7 does not exist: |$email_attachment_7|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_7: |$email_attachment_7|\n";
                            }
                            $email_attachment_7='';
                        }
                        if (strlen($email_attachment_8) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_8)) or (file_exists($PATHLEGemail_attachment_8))) {
                                if (!file_exists($PATHemail_attachment_8)) {
                                    $PATHemail_attachment_8 = $PATHLEGemail_attachment_8;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_8: $filename_8($PATHemail_attachment_8) $file_size\n";
                                }
                                $attach_messages .= "attachment_8: $filename_8($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_8 does not exist: |$email_attachment_8|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_8: |$email_attachment_8|\n";
                            }
                            $email_attachment_8='';
                        }
                        if (strlen($email_attachment_9) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_9)) or (file_exists($PATHLEGemail_attachment_9))) {
                                if (!file_exists($PATHemail_attachment_9)) {
                                    $PATHemail_attachment_9 = $PATHLEGemail_attachment_9;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_9: $filename_9($PATHemail_attachment_9) $file_size\n";
                                }
                                $attach_messages .= "attachment_9: $filename_9($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_9 does not exist: |$email_attachment_9|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_9: |$email_attachment_9|\n";
                            }
                            $email_attachment_9='';
                        }
                        if (strlen($email_attachment_10) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_10)) or (file_exists($PATHLEGemail_attachment_10))) {
                                if (!file_exists($PATHemail_attachment_10)) {
                                    $PATHemail_attachment_10 = $PATHLEGemail_attachment_10;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_10: $filename_10($PATHemail_attachment_10) $file_size\n";
                                }
                                $attach_messages .= "attachment_10: $filename_10($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_10 does not exist: |$email_attachment_10|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_10: |$email_attachment_10|\n";
                            }
                            $email_attachment_10='';
                        }
                        if (strlen($email_attachment_11) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_11)) or (file_exists($PATHLEGemail_attachment_11))) {
                                if (!file_exists($PATHemail_attachment_11)) {
                                    $PATHemail_attachment_11 = $PATHLEGemail_attachment_11;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_11: $filename_11($PATHemail_attachment_11) $file_size\n";
                                }
                                $attach_messages .= "attachment_11: $filename_11($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_11 does not exist: |$email_attachment_11|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_11: |$email_attachment_11|\n";
                            }
                            $email_attachment_11='';
                        }
                        if (strlen($email_attachment_12) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_12)) or (file_exists($PATHLEGemail_attachment_12))) {
                                if (!file_exists($PATHemail_attachment_12)) {
                                    $PATHemail_attachment_12 = $PATHLEGemail_attachment_12;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_12: $filename_12($PATHemail_attachment_12) $file_size\n";
                                }
                                $attach_messages .= "attachment_12: $filename_12($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_12 does not exist: |$email_attachment_12|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_12: |$email_attachment_12|\n";
                            }
                            $email_attachment_12='';
                        }
                        if (strlen($email_attachment_13) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_13)) or (file_exists($PATHLEGemail_attachment_13))) {
                                if (!file_exists($PATHemail_attachment_13)) {
                                    $PATHemail_attachment_13 = $PATHLEGemail_attachment_13;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_13: $filename_13($PATHemail_attachment_13) $file_size\n";
                                }
                                $attach_messages .= "attachment_13: $filename_13($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_13 does not exist: |$email_attachment_13|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_13: |$email_attachment_13|\n";
                            }
                            $email_attachment_13='';
                        }
                        if (strlen($email_attachment_14) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_14)) or (file_exists($PATHLEGemail_attachment_14))) {
                                if (!file_exists($PATHemail_attachment_14)) {
                                    $PATHemail_attachment_14 = $PATHLEGemail_attachment_14;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_14: $filename_14($PATHemail_attachment_14) $file_size\n";
                                }
                                $attach_messages .= "attachment_14: $filename_14($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_14 does not exist: |$email_attachment_14|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_14: |$email_attachment_14|\n";
                            }
                            $email_attachment_14='';
                        }
                        if (strlen($email_attachment_15) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_15)) or (file_exists($PATHLEGemail_attachment_15))) {
                                if (!file_exists($PATHemail_attachment_15)) {
                                    $PATHemail_attachment_15 = $PATHLEGemail_attachment_15;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_15: $filename_15($PATHemail_attachment_15) $file_size\n";
                                }
                                $attach_messages .= "attachment_15: $filename_15($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_15 does not exist: |$email_attachment_15|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_15: |$email_attachment_15|\n";
                            }
                            $email_attachment_15='';
                        }
                        if (strlen($email_attachment_16) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_16)) or (file_exists($PATHLEGemail_attachment_16))) {
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_16: $filename_16($PATHemail_attachment_16) $file_size\n";
                                }
                                $attach_messages .= "attachment_16: $filename_16($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_16 does not exist: |$email_attachment_16|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_16: |$email_attachment_16|\n";
                            }
                            $email_attachment_16='';
                        }
                        if (strlen($email_attachment_17) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_17)) or (file_exists($PATHLEGemail_attachment_17))) {
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_17: $filename_17($PATHemail_attachment_17) $file_size\n";
                                }
                                $attach_messages .= "attachment_17: $filename_17($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_17 does not exist: |$email_attachment_17|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_17: |$email_attachment_17|\n";
                            }
                            $email_attachment_17='';
                        }
                        if (strlen($email_attachment_18) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_18)) or (file_exists($PATHLEGemail_attachment_18))) {
                                if (!file_exists($PATHemail_attachment_18)) {
                                    $PATHemail_attachment_18 = $PATHLEGemail_attachment_18;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_18: $filename_18($PATHemail_attachment_18) $file_size\n";
                                }
                                $attach_messages .= "attachment_18: $filename_18($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_18 does not exist: |$email_attachment_18|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_18: |$email_attachment_18|\n";
                            }
                            $email_attachment_18='';
                        }
                        if (strlen($email_attachment_19) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_19)) or (file_exists($PATHLEGemail_attachment_19))) {
                                if (!file_exists($PATHemail_attachment_19)) {
                                    $PATHemail_attachment_19 = $PATHLEGemail_attachment_19;
                                }
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_19: $filename_19($PATHemail_attachment_19) $file_size\n";
                                }
                                $attach_messages .= "attachment_19: $filename_19($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_19 does not exist: |$email_attachment_19|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_19: |$email_attachment_19|\n";
                            }
                            $email_attachment_19='';
                        }
                        if (strlen($email_attachment_20) > 4) {
                            ...
                            if ((file_exists($PATHemail_attachment_20)) or (file_exists($PATHLEGemail_attachment_20))) {
                                ...
                                if ($DB > 1) {
                                    echo "valid attachment_20: $filename_20($PATHemail_attachment_20) $file_size\n";
                                }
                                $attach_messages .= "attachment_20: $filename_20($file_size)|";
                                $valid_attachments++;
                            } else {
                                if ($DB > 1) {
                                    echo "attachment_20 does not exist: |$email_attachment_20|\n";
                                }
                            ...
                            if ($DB > 1) {
                                echo "invalid attachment_20: |$email_attachment_20|\n";
                            }
                            $email_attachment_20='';
                        }
                    }
                    if ($valid_attachments > 0) {
                        // Email header
                        if(isset($email_display_name)) {
                            $from_string = '"'.$email_display_name.'" <'.$email_from.'>';
                        } else {
                            $from_string = $email_from;
                        }
