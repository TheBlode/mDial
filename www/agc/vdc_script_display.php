...
if (isset($_GET["SCRIPTcamp_script"])) {
    $SCRIPTcamp_script=$_GET["SCRIPTcamp_script"];
} elseif (isset($_POST["SCRIPTcamp_script"])) {
    $SCRIPTcamp_script=$_POST["SCRIPTcamp_script"];
}
if (isset($_GET["SCRIPTin_script"])) {
    $SCRIPTin_script=$_GET["SCRIPTin_script"];
} elseif (isset($_POST["SCRIPTin_script"])) {
    $SCRIPTin_script=$_POST["SCRIPTin_script"];
}
...
if (isset($_GET["ScrollDIV"])) {
    $ScrollDIV=$_GET["ScrollDIV"];
} elseif (isset($_POST["ScrollDIV"])) {
    $ScrollDIV=$_POST["ScrollDIV"];
}
if (isset($_GET["ignore_list_script"])) {
    $ignore_list_script=$_GET["ignore_list_script"];
} elseif (isset($_POST["ignore_list_script"])) {
    $ignore_list_script=$_POST["ignore_list_script"];
}
if (isset($_GET["CF_uses_custom_fields"])) {
    $CF_uses_custom_fields=$_GET["CF_uses_custom_fields"];
} elseif (isset($_POST["CF_uses_custom_fields"])) {
    $CF_uses_custom_fields=$_POST["CF_uses_custom_fields"];
}
...
if (isset($_GET["orig_pass"])) {
    $orig_pass=$_GET["orig_pass"];
} elseif (isset($_POST["orig_pass"])) {
    $orig_pass=$_POST["orig_pass"];
}
...
if (isset($_GET["script_override"])) {
    $script_override=$_GET["script_override"];
} elseif (isset($_POST["script_override"])) {
...
if (isset($_GET["script_span"])) {
    $script_span=$_GET["script_span"];
} elseif (isset($_POST["script_span"])) {
    $script_span=$_POST["script_span"];
}
if (isset($_GET["user_group_script"])) {
    $user_group_script=$_GET["user_group_script"];
} elseif (isset($_POST["user_group_script"])) {
    $user_group_script=$_POST["user_group_script"];
}
if (isset($_GET["UGscript_id"])) {
    $UGscript_id=$_GET["UGscript_id"];
} elseif (isset($_POST["UGscript_id"])) {
    $UGscript_id=$_POST["UGscript_id"];
}
...
if ($DB > 0) {
    echo "DEBUG: |$ignore_list_script|$script_span|$user_group_script|$UGscript_id|\n";
}
...
if ($CF_uses_custom_fields=='Y') {
    ...
    while ($cffn_ct > $d) {
        ...
        if ($DB) {
            echo "$d|$field_name_id|$field_name_tag|$form_field_value|<br>\n";
        }
        $d++;
    }
}
