...
if (isset($_GET["group_alias"])) {
    $group_alias=$_GET["group_alias"];
} elseif (isset($_POST["group_alias"])) {
    $group_alias=$_POST["group_alias"];
}
if (isset($_GET["dial_prefix"])) {
    $dial_prefix=$_GET["dial_prefix"];
} elseif (isset($_POST["dial_prefix"])) {
...
if (isset($_GET["vtiger_callback"])) {
    $vtiger_callback=$_GET["vtiger_callback"];
} elseif (isset($_POST["vtiger_callback"])) {
    $vtiger_callback=$_POST["vtiger_callback"];
}
if (isset($_GET["blended"])) {
    $blended=$_GET["blended"];
} elseif (isset($_POST["blended"])) {
    $blended=$_POST["blended"];
}
if (isset($_GET["ingroup_choices"])) {
    $ingroup_choices=$_GET["ingroup_choices"];
} elseif (isset($_POST["ingroup_choices"])) {
    $ingroup_choices=$_POST["ingroup_choices"];
}
if (isset($_GET["set_as_default"])) {
    $set_as_default=$_GET["set_as_default"];
} elseif (isset($_POST["set_as_default"])) {
    $set_as_default=$_POST["set_as_default"];
}
if (isset($_GET["alt_user"])) {
    $alt_user=$_GET["alt_user"];
} elseif (isset($_POST["alt_user"])) {
...
if (isset($_GET["close_window_link"])) {
    $close_window_link=$_GET["close_window_link"];
} elseif (isset($_POST["close_window_link"])) {
    $close_window_link=$_POST["close_window_link"];
}
...
if (isset($_GET["dial_override"])) {
    $dial_override=$_GET["dial_override"];
} elseif (isset($_POST["dial_override"])) {
    $dial_override=$_POST["dial_override"];
}
if (isset($_GET["consultative"])) {
    $consultative=$_GET["consultative"];
} elseif (isset($_POST["consultative"])) {
    $consultative=$_POST["consultative"];
}
if (isset($_GET["alt_dial"])) {
    $alt_dial=$_GET["alt_dial"];
} elseif (isset($_POST["alt_dial"])) {
    $alt_dial=$_POST["alt_dial"];
}
if (isset($_GET["DB"])) {
    $DB=$_GET["DB"];
...
if (isset($_GET["qm_dispo_code"])) {
    $qm_dispo_code=$_GET["qm_dispo_code"];
} elseif (isset($_POST["qm_dispo_code"])) {
    $qm_dispo_code=$_POST["qm_dispo_code"];
}
if (isset($_GET["agent_debug"])) {
    $agent_debug=$_GET["agent_debug"];
} elseif (isset($_POST["agent_debug"])) {
    $agent_debug=$_POST["agent_debug"];
}
if (isset($_GET["dial_ingroup"])) {
    $dial_ingroup=$_GET["dial_ingroup"];
} elseif (isset($_POST["dial_ingroup"])) {
    $dial_ingroup=$_POST["dial_ingroup"];
}
if (isset($_GET["cid_choice"])) {
    $cid_choice=$_GET["cid_choice"];
} elseif (isset($_POST["cid_choice"])) {
    $cid_choice=$_POST["cid_choice"];
}
...
} elseif (isset($_POST["recipient_type"])) {
    $recipient_type=$_POST["recipient_type"];
}
if (isset($_GET["show_confetti"])) {
    $show_confetti=$_GET["show_confetti"];
} elseif (isset($_POST["show_confetti"])) {
    $show_confetti=$_POST["show_confetti"];
}
if (isset($_GET["maxParticleCount"])) {
    $maxParticleCount=$_GET["maxParticleCount"];
} elseif (isset($_POST["maxParticleCount"])) {
    $maxParticleCount=$_POST["maxParticleCount"];
}
if (isset($_GET["particleSpeed"])) {
    $particleSpeed=$_GET["particleSpeed"];
} elseif (isset($_POST["particleSpeed"])) {
    $particleSpeed=$_POST["particleSpeed"];
}
if (isset($_GET["notification_date"])) {
    $notification_date=$_GET["notification_date"];
} elseif (isset($_POST["notification_date"])) {
    $notification_date=$_POST["notification_date"];
}
if (isset($_GET["notification_text"])) {
    $notification_text=$_GET["notification_text"];
} elseif (isset($_POST["notification_text"])) {
    $notification_text=$_POST["notification_text"];
}
if (isset($_GET["notification_retry"])) {
    $notification_retry=$_GET["notification_retry"];
} elseif (isset($_POST["notification_retry"])) {
    $notification_retry=$_POST["notification_retry"];
}
if (isset($_GET["text_size"])) {
    $text_size=$_GET["text_size"];
} elseif (isset($_POST["text_size"])) {
    $text_size=$_POST["text_size"];
}
if (isset($_GET["text_font"])) {
    $text_font=$_GET["text_font"];
} elseif (isset($_POST["text_font"])) {
    $text_font=$_POST["text_font"];
}
if (isset($_GET["text_weight"])) {
    $text_weight=$_GET["text_weight"];
} elseif (isset($_POST["text_weight"])) {
    $text_weight=$_POST["text_weight"];
}
if (isset($_GET["text_color"])) {
    $text_color=$_GET["text_color"];
} elseif (isset($_POST["text_color"])) {
...
if ($ACTION == 'LogiNCamPaigns') {
    ...
    if (($VUapi_list_restrict > 0) and (($function == 'feature_not_needed') or ($function == 'feature_not_needed2'))) {
        ...
        if ($ss_conf_ct > 0) {
            ...
            if ($DB>0) {
                echo "Allowed lists:|$allowed_lists|\n";
            }
        } else {
            $result = _QXZ("ERROR");
        ...
        if ($row[0] > 0) {
            ...
            if (strlen($callback_datetime) > 12) {
                ...
                if ($CB_status_found > 0) {
                    ...
                    while (strlen($callback_comments) > 200) {
                        $callback_comments = preg_replace("/.$/", '', $callback_comments);
                    }
                ...
                if ($row[0] > 0) {
                    ...
                    if ((preg_match("/YES/i", $vtiger_callback)) and (preg_match("/^99/", $value))) {
                        ...
                        if ($enable_vtiger_integration > 0) {
                            ...
                            if (!$linkV) {
                                die(_QXZ("Could not connect: ")."$vtiger_server_ip|$vtiger_dbname|$vtiger_login|$vtiger_pass" . mysqli_connect_error());
                            }
            ...
            if ($row[0] > 0) {
                ...
                if ($lead_id > 0) {
                    ...
                    if (preg_match('/phone_code/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("phone_code set to")." $phone_code\n";
                        }
                    ...
                    if (preg_match('/address1/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("address1 set to")." $address1\n";
                        }
                    ...
                    if (preg_match('/address2/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("address2 set to")." $address2\n";
                        }
                    ...
                    if (preg_match('/address3/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("address3 set to")." $address3\n";
                        }
                    ...
                    if (preg_match('/alt_phone/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("alt_phone set to")." $alt_phone\n";
                        }
                    ...
                    if (preg_match('/comments/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("comments set to")." $comments\n";
                        }
                    ...
                    if (preg_match('/country_code/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("country_code set to")." $country_code\n";
                        }
                    ...
                    if (preg_match('/date_of_birth/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("date_of_birth set to")." $date_of_birth\n";
                        }
                    ...
                    if (preg_match('/first_name/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("first_name set to")." $first_name\n";
                        }
                    ...
                    if (preg_match('/gender/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("gender set to")." $gender\n";
                        }
                    ...
                    if (preg_match('/gmt_offset_now/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("gmt_offset_now set to")." $gmt_offset_now\n";
                        }
                    ...
                    if (preg_match('/last_name/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("last_name set to")." $last_name\n";
                        }
                    ...
                    if (preg_match('/middle_initial/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("middle_initial set to")." $middle_initial\n";
                        }
                    ...
                    if (preg_match('/phone_number/', $query_string)) {
                        if ($DB) {
                            echo _QXZ("phone_number set to")." $phone_number\n";
                        }
                    ...
                    if (preg_match('/postal_code/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("postal_code set to")." $postal_code\n";
                        }
                    ...
                    if (preg_match('/province/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("province set to")." $province\n";
                        }
                    ...
                    if (preg_match('/security_phrase/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("security_phrase set to")." $security_phrase\n";
                        }
                    ...
                    if (preg_match('/source_id/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("source_id set to")." $source_id\n";
                        }
                    ...
                    if (preg_match('/vendor_lead_code/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("vendor_lead_code set to")." $vendor_lead_code\n";
                        }
                    ...
                    if (preg_match('/formreload/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("form reload triggered")."\n";
                        }
                    ...
                    if (preg_match('/scriptreload/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("script reload triggered")."\n";
                        }
                    ...
                    if (preg_match('/script2reload/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("script 2 reload triggered")."\n";
                        }
                    ...
                    if (preg_match('/emailreload/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("email reload triggered")."\n";
                        }
                    ...
                    if (preg_match('/chatreload/i', $query_string)) {
                        if ($DB) {
                            echo _QXZ("chat reload triggered")."\n";
                        }
                    ...
                    if ($camp_ct > 0) {
                        ...
                        if (($agent_lead_search == 'LIVE_CALL_INBOUND') or ($agent_lead_search == 'LIVE_CALL_INBOUND_AND_MANUAL')) {
                            ...
                            if (strlen($vendor_lead_code)>0) {
                                $searchSQL = "vendor_lead_code='$vendor_lead_code' order by lead_id desc limit 1";
                            }
...
if ($function == 'send_notification') {
    if ($SSagent_notifications < 1) {
        ...
        if ($recipient && $recipient_type) {
            ...
            if($recipient_type=="CAMPAIGN" || $recipient_type=="USER_GROUP") {
                ...
                if ($ss_conf_ct > 0) {
                    ...
                    if ($recipient_type=="CAMPAIGN" && (!preg_match('/\-ALL/i', $LOGallowed_campaigns)) && !preg_match("/ $recipient /i", $LOGallowed_campaigns)) {
                        ...
                        api_log($link, $api_logging, $api_script, $user, $agent_user, $function, $value, $result, $result_reason, $source, $data);
                        exit;
                    } elseif ($recipient_type=="USER_GROUP" && (!preg_match('/\-\-\-ALL/i', $LOGadmin_viewable_groups)) && !preg_match("/ $recipient /i", $LOGadmin_viewable_groups)) {
                        $result = _QXZ("ERROR");
            ...
            if (preg_match('/^[0-9A-F]{3,6}$/', $text_color)) {
