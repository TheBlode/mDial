...
if (isset($_GET["campaign_check"])) {
    $campaign_check=$_GET["campaign_check"];
} elseif (isset($_POST["campaign_check"])) {
...
if ($DB>0) {
    echo "$lead_id|$search_field|$campaign_check|$sale_status|$dispo|$new_status|$user|$pass|$DB|$log_to_file|\n";
}
