...
if (isset($_GET["logged_status"])) {
    $logged_status=$_GET["logged_status"];
} elseif (isset($_POST["logged_status"])) {
...
if (isset($_GET["days_search"])) {
    $days_search=$_GET["days_search"];
} elseif (isset($_POST["days_search"])) {
    $days_search=$_POST["days_search"];
}
...
if (isset($_GET["in_out_search"])) {
    $in_out_search=$_GET["in_out_search"];
} elseif (isset($_POST["in_out_search"])) {
    $in_out_search=$_POST["in_out_search"];
}
...
if ($DB>0) {
    echo "$lead_id|$dispo|$logged_status|$logged_count|$new_status|$days_search|$archive_search|$in_out_search|$user|$pass|$DB|$log_to_file|\n";
}
