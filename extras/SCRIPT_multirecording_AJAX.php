...
if (isset($_GET["rec_action"])) {
    $rec_action=$_GET["rec_action"];
} elseif (isset($_POST["rec_action"])) {
    $rec_action=$_POST["rec_action"];
}
if (isset($_GET["recording_channel"])) {
    $recording_channel=$_GET["recording_channel"];
} elseif (isset($_POST["recording_channel"])) {
